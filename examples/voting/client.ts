...
export const APP_SPEC: Arc56Contract = {"arcs":[],"name":"VotingRoundApp","structs":{"VotingPreconditions":{"is_voting_open":"uint64","is_allowed_to_vote":"uint64","has_already_voted":"uint64","current_time":"uint64"}},"methods":[{"name":"create","args":[{"name":"vote_id","type":"string"},{"name":"snapshot_public_key","type":"byte[]"},{"name":"metadata_ipfs_cid","type":"string"},{"name":"start_time","type":"uint64"},{"name":"end_time","type":"uint64"},{"name":"option_counts","type":"uint8[]"},{"name":"quorum","type":"uint64"},{"name":"nft_image_url","type":"string"}],"returns":{"type":"void"},"events":[],"actions":{"create":["NoOp"],"call":[]}},{"name":"bootstrap","args":[{"name":"fund_min_bal_req","type":"pay"}],"returns":{"type":"void"},"events":[],"actions":{"create":[],"call":["NoOp"]}},{"name":"close","args":[],"returns":{"type":"void"},"events":[],"actions":{"create":[],"call":["NoOp"]}},{"name":"get_preconditions","desc":"Returns the calculated pre-conditions for the voting round.","args":[{"name":"signature","type":"byte[]","desc":"The signature for the given voter account"}],"returns":{"type":"(uint64,uint64,uint64,uint64)","desc":"The precondition values","struct":"VotingPreconditions"},"events":[],"readonly":true,"actions":{"create":[],"call":["NoOp"]}},{"name":"vote","args":[{"name":"fund_min_bal_req","type":"pay"},{"name":"signature","type":"byte[]"},{"name":"answer_ids","type":"uint8[]"}],"returns":{"type":"void"},"events":[],"actions":{"create":[],"call":["NoOp"]}}],"state":{"schema":{"global":{"ints":8,"bytes":5},"local":{"ints":0,"bytes":0}},"keys":{"global":{"close_time":{"key":"Y2xvc2VfdGltZQ==","keyType":"bytes","valueType":"uint64","desc":"The unix timestamp of the time the vote was closed"},"end_time":{"key":"ZW5kX3RpbWU=","keyType":"bytes","valueType":"uint64","desc":"The unix timestamp of the ending time of voting"},"is_bootstrapped":{"key":"aXNfYm9vdHN0cmFwcGVk","keyType":"bytes","valueType":"uint64","desc":"Whether or not the contract has been bootstrapped with answers"},"metadata_ipfs_cid":{"key":"bWV0YWRhdGFfaXBmc19jaWQ=","keyType":"bytes","valueType":"bytes","desc":"The IPFS content ID of the voting metadata file"},"nft_asset_id":{"key":"bmZ0X2Fzc2V0X2lk","keyType":"bytes","valueType":"uint64","desc":"The asset ID of a result NFT if one has been created"},"nft_image_url":{"key":"bmZ0X2ltYWdlX3VybA==","keyType":"bytes","valueType":"bytes","desc":"The IPFS URL of the default image to use as the media of the result NFT"},"option_counts":{"key":"b3B0aW9uX2NvdW50cw==","keyType":"bytes","valueType":"bytes","desc":"The number of options for each question"},"quorum":{"key":"cXVvcnVt","keyType":"bytes","valueType":"uint64","desc":"The minimum number of voters to reach quorum"},"snapshot_public_key":{"key":"c25hcHNob3RfcHVibGljX2tleQ==","keyType":"bytes","valueType":"bytes","desc":"The public key of the Ed25519 compatible private key that was used to encrypt entries in the vote gating snapshot"},"start_time":{"key":"c3RhcnRfdGltZQ==","keyType":"bytes","valueType":"uint64","desc":"The unix timestamp of the starting time of voting"},"total_options":{"key":"dG90YWxfb3B0aW9ucw==","keyType":"bytes","valueType":"uint64","desc":"The total number of options"},"vote_id":{"key":"dm90ZV9pZA==","keyType":"bytes","valueType":"bytes","desc":"The identifier of this voting round"},"voter_count":{"key":"dm90ZXJfY291bnQ=","keyType":"bytes","valueType":"uint64","desc":"The minimum number of voters who have voted"}},"local":{},"box":{}},"maps":{"global":{},"local":{},"box":{}}},"source":{"approval":"","clear":"I3ByYWdtYSB2ZXJzaW9uIDgKcHVzaGludCAwIC8vIDAKcmV0dXJu"},"bareActions":{"create":[],"call":["DeleteApplication"]}}
...
/**
 * Converts the ABI return of a VotingPreconditions to the struct representation
 */
export function VotingPreconditionsABIReturnFormatter(returnValue: ABIReturn | undefined) {
  if (returnValue === undefined) return undefined
  if (returnValue.decodeError) throw returnValue.decodeError
  return getABIStructFromABITuple<VotingPreconditions>(returnValue.returnValue as ABIValue[],
    {isVotingOpen: 'uint64', isAllowedToVote: 'uint64', hasAlreadyVoted: 'uint64', currentTime: 'uint64'}
  )
}
/**
 * Converts a VotingPreconditions to an ABI tuple
 */
export function VotingPreconditionsToABITuple(struct: VotingPreconditions) {
...
export abstract class VotingRoundAppParamsFactory {
  ...
  static getPreconditions(params: CallParams<'get_preconditions(byte[])(uint64,uint64,uint64,uint64)'> & CallOnComplete): AppClientMethodCallParams & CallOnComplete {
    return {
      ...
      returnValueFormatter: VotingPreconditionsABIReturnFormatter
    }
  }
  /**
...
export class VotingRoundAppFactory {
  ...
  public async getAppClientByCreatorAddressAndName(
    ...
    return new VotingRoundAppClient(await this.appFactory.getAppClientByCreatorAddressAndName(params))
  }
  ...
  public async deploy(params: VotingRoundAppDeployParams = {}) {
    ...
    return { result: result.result, app: new VotingRoundAppClient(result.app) }
  }
    ...
    return {
      ...
      get create() {
        return {
           ...
           */
          async create(params: Expand<CallParams<'create(string,byte[],string,uint64,uint64,uint8[],uint64,string)void'> & AppClientCompilationParams & CreateSchema & ExecuteParams & {onComplete?: OnApplicationComplete.NoOpOC}>) {
            const result = await $this.appFactory.create(VotingRoundAppParamsFactory.create.create(params))
            return { result: { ...result.result, return: result.result.return as undefined | MethodReturn<'create(string,byte[],string,uint64,uint64,uint8[],uint64,string)void'> }, app: new VotingRoundAppClient(result.app) }
          },
        }
      },
...
export class VotingRoundAppClient {
  ...
  decodeReturnValue<TSignature extends VotingRoundAppNonVoidMethodSignatures>(method: TSignature, returnValue: ABIReturn | undefined) {
    return returnValue !== undefined ? getArc56ReturnValue<MethodReturn<TSignature>>(returnValue, this.appClient.getABIMethod(method), {votingPreconditions: {isVotingOpen: 'uint64', isAllowedToVote: 'uint64', hasAlreadyVoted: 'uint64', currentTime: 'uint64'}}) : undefined
  }
  ...
  readonly transactions = (($this) => {
    return {
       ...
       */
      bootstrap(params: Expand<CallParams<'bootstrap(pay)void'> & {onComplete?: OnApplicationComplete.NoOpOC}>) {
        return $this.appClient.transactions.call(VotingRoundAppParamsFactory.bootstrap(params))
      },
      /**
       * Makes a call to the VotingRoundApp smart contract using the close()void ABI method.
       *
       ...
       */
      close(params: Expand<CallParams<'close()void'> & {onComplete?: OnApplicationComplete.NoOpOC}> = {args: []}) {
        return $this.appClient.transactions.call(VotingRoundAppParamsFactory.close(params))
      },
      /**
       * Makes a call to the VotingRoundApp smart contract using the get_preconditions(byte[])(uint64,uint64,uint64,uint64) ABI method.
       *
       ...
       */
      getPreconditions(params: Expand<CallParams<'get_preconditions(byte[])(uint64,uint64,uint64,uint64)'> & {onComplete?: OnApplicationComplete.NoOpOC}>) {
        return $this.appClient.transactions.call(VotingRoundAppParamsFactory.getPreconditions(params))
      },
      /**
       * Makes a call to the VotingRoundApp smart contract using the vote(pay,byte[],uint8[])void ABI method.
       *
       ...
       */
      vote(params: Expand<CallParams<'vote(pay,byte[],uint8[])void'> & {onComplete?: OnApplicationComplete.NoOpOC}>) {
        return $this.appClient.transactions.call(VotingRoundAppParamsFactory.vote(params))
      },
    }
  })(this)
  ...
  readonly send = (($this) => {
    return {
       ...
       */
      async bootstrap(params: Expand<CallParams<'bootstrap(pay)void'> & ExecuteParams & {onComplete?: OnApplicationComplete.NoOpOC}>) {
       ...
       * @returns The call result
       */
      async close(params: Expand<CallParams<'close()void'> & ExecuteParams & {onComplete?: OnApplicationComplete.NoOpOC}> = {args: []}) {
       ...
       */
      async getPreconditions(params: Expand<CallParams<'get_preconditions(byte[])(uint64,uint64,uint64,uint64)'> & ExecuteParams & {onComplete?: OnApplicationComplete.NoOpOC}>) {
       ...
       * @returns The call result
       */
      async vote(params: Expand<CallParams<'vote(pay,byte[],uint8[])void'> & ExecuteParams & {onComplete?: OnApplicationComplete.NoOpOC}>) {
  ...
  public newGroup(): VotingRoundAppComposer {
    ...
    return {
      ...
      bootstrap(params: CallParams<'bootstrap(pay)void'> & {onComplete?: OnApplicationComplete.NoOpOC}) {
        composer.addAppCallMethodCall(client.params.bootstrap(params))
      ...
      close(params: CallParams<'close()void'> & {onComplete?: OnApplicationComplete.NoOpOC}) {
        composer.addAppCallMethodCall(client.params.close(params))
        resultMappers.push(undefined)
        return this
      },
      /**
      ...
      getPreconditions(params: CallParams<'get_preconditions(byte[])(uint64,uint64,uint64,uint64)'> & {onComplete?: OnApplicationComplete.NoOpOC}) {
        composer.addAppCallMethodCall(client.params.getPreconditions(params))
      ...
      vote(params: CallParams<'vote(pay,byte[],uint8[])void'> & {onComplete?: OnApplicationComplete.NoOpOC}) {
        composer.addAppCallMethodCall(client.params.vote(params))
        resultMappers.push(undefined)
        return this
      },
      get delete() {
...
export type VotingRoundAppComposer<TReturns extends [...any[]] = []> = {
   ...
   */
  execute(params?: ExecuteParams): Promise<VotingRoundAppComposerResults<TReturns>>
}
