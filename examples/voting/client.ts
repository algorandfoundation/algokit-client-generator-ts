...
export class VotingRoundAppFactory {
  ...
  readonly send = {
    ...
    create: {
       ...
       */
      create: async (params: Expand<CallParams<'create(string,byte[],string,uint64,uint64,uint8[],uint64,string)void'> & AppClientCompilationParams & CreateSchema & SendParams & {onComplete?: OnApplicationComplete.NoOpOC}>) => {
...
export class VotingRoundAppClient {
  ...
  readonly send = {
     ...
     */
    bootstrap: async (params: Expand<CallParams<'bootstrap(pay)void'> & SendParams & {onComplete?: OnApplicationComplete.NoOpOC}>) => {
     ...
     * @returns The call result
     */
    close: async (params: Expand<CallParams<'close()void'> & SendParams & {onComplete?: OnApplicationComplete.NoOpOC}> = {args: []}) => {
     ...
     */
    getPreconditions: async (params: Expand<CallParams<'get_preconditions(byte[])(uint64,uint64,uint64,uint64)'> & SendParams & {onComplete?: OnApplicationComplete.NoOpOC}>) => {
     ...
     * @returns The call result
     */
    vote: async (params: Expand<CallParams<'vote(pay,byte[],uint8[])void'> & SendParams & {onComplete?: OnApplicationComplete.NoOpOC}>) => {
