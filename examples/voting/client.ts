...
export class VotingRoundAppClient {
   ...
   * @param params The parameters to create the app client
   */
  public static async fromCreatorAndName(params: Expand<Omit<ResolveAppClientByCreatorAndName, 'appSpec'>>): Promise<VotingRoundAppClient> {
