...
export class NestedClient {
  ...
  readonly params = {
     ...
     * @returns The call params
     */
    get_pay_txn_amount: (params: CallParams<NestedArgs['obj']['get_pay_txn_amount(pay)uint64'] | NestedArgs['tuple']['get_pay_txn_amount(pay)uint64']> & { onComplete?: OnApplicationComplete.NoOp }) => {
     ...
     * @returns The call params
     */
    nested_method_call: (params: CallParams<NestedArgs['obj']['nested_method_call(string,pay,appl)byte[]'] | NestedArgs['tuple']['nested_method_call(string,pay,appl)byte[]']> & { onComplete?: OnApplicationComplete.NoOp }) => {
  ...
  readonly send = {
     ...
     * @returns The call result
     */
    get_pay_txn_amount: async (params: CallParams<NestedArgs['obj']['get_pay_txn_amount(pay)uint64'] | NestedArgs['tuple']['get_pay_txn_amount(pay)uint64']> & SendParams & { onComplete?: OnApplicationComplete.NoOp }) => {
     ...
     * @returns The call result
     */
    nested_method_call: async (params: CallParams<NestedArgs['obj']['nested_method_call(string,pay,appl)byte[]'] | NestedArgs['tuple']['nested_method_call(string,pay,appl)byte[]']> & SendParams & { onComplete?: OnApplicationComplete.NoOp }) => {
