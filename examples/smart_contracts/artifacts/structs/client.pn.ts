...
export class StructsClient {
  ...
  state = {
    ...
    global: {
       ...
       */
      my_struct: async (): Promise<Vector | undefined> => {
       ...
       */
      my_nested_struct: async (): Promise<RootStruct | undefined> => {
    ...
    local: (address: string | Address) => {
      ...
      return {
         ...
         */
        my_localstate_struct: async (): Promise<Vector | undefined> => {
         ...
         */
        my_nested_localstate_struct: async (): Promise<RootStruct | undefined> => {
    ...
    box: {
       ...
       */
      my_box_struct: async (): Promise<Vector | undefined> => {
       ...
       */
      my_nested_box_struct: async (): Promise<RootStruct | undefined> => {
