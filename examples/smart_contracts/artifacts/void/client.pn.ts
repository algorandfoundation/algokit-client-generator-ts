...
export abstract class VoidParamsFactory {
   ...
   */
  static do_nothing(params: CallParams<VoidArgs['obj']['do_nothing()void'] | VoidArgs['tuple']['do_nothing()void']> & CallOnComplete): AppClientMethodCallParams & CallOnComplete {
    return {
      ...params,
...
export class VoidClient {
  ...
  readonly params = {
     ...
     */
    do_nothing: (params: CallParams<VoidArgs['obj']['do_nothing()void'] | VoidArgs['tuple']['do_nothing()void']> & { onComplete?: OnApplicationComplete.NoOp } = {args: []}) => {
      return this.appClient.params.call(VoidParamsFactory.do_nothing(params))
    },
  ...
  readonly createTransaction = {
     ...
     */
    do_nothing: (params: CallParams<VoidArgs['obj']['do_nothing()void'] | VoidArgs['tuple']['do_nothing()void']> & { onComplete?: OnApplicationComplete.NoOp } = {args: []}) => {
      return this.appClient.createTransaction.call(VoidParamsFactory.do_nothing(params))
    },
  ...
  readonly send = {
     ...
     */
    do_nothing: async (params: CallParams<VoidArgs['obj']['do_nothing()void'] | VoidArgs['tuple']['do_nothing()void']> & SendParams & { onComplete?: OnApplicationComplete.NoOp } = {args: []}) => {
      const result = await this.appClient.send.call(VoidParamsFactory.do_nothing(params))
  ...
  public newGroup(composerConfig?: TransactionComposerConfig): VoidComposer {
    ...
    return {
       ...
       */
      do_nothing(params: CallParams<VoidArgs['obj']['do_nothing()void'] | VoidArgs['tuple']['do_nothing()void']> & { onComplete?: OnApplicationComplete.NoOp }) {
        promiseChain = promiseChain.then(async () => composer.addAppCallMethodCall(await client.params.do_nothing(params)))
        return this
      },
      get update() {
        return {
...
export type VoidComposer<TReturns extends [...any[]] = []> = {
   ...
   */
  do_nothing(params?: CallParams<VoidArgs['obj']['do_nothing()void'] | VoidArgs['tuple']['do_nothing()void']>): VoidComposer<[...TReturns, VoidReturns['do_nothing()void'] | undefined]>
