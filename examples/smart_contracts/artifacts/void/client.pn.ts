...
export class VoidClient {
  ...
  readonly params = {
     ...
     */
    do_nothing: (params: CallParams<VoidArgs['obj']['do_nothing()void'] | VoidArgs['tuple']['do_nothing()void']> & {onComplete?: OnApplicationComplete.NoOpOC} = {args: []}) => {
  ...
  readonly send = {
     ...
     */
    do_nothing: async (params: CallParams<VoidArgs['obj']['do_nothing()void'] | VoidArgs['tuple']['do_nothing()void']> & SendParams & {onComplete?: OnApplicationComplete.NoOpOC} = {args: []}) => {
  ...
  public newGroup(): VoidComposer {
    ...
    return {
       ...
       */
      do_nothing(params: CallParams<VoidArgs['obj']['do_nothing()void'] | VoidArgs['tuple']['do_nothing()void']> & {onComplete?: OnApplicationComplete.NoOpOC}) {
