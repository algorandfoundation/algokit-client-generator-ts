...
export type PayoutInfo = { amountToSeller: bigint, commissionAddress: string, amountToCommission: bigint, segmentRootOwner: string, amountToSegmentRoot: bigint }
...
export abstract class NfdInstanceParamsFactory {
  ...
  static get create() {
    return {
       ...
       */
      createApplication(params: CallParams<NfdInstanceArgs['obj']['createApplication(string,address,address,uint64,uint64,address,uint64,address,uint64,uint64,address)void'] | NfdInstanceArgs['tuple']['createApplication(string,address,address,uint64,uint64,address,uint64,address,uint64,uint64,address)void']> & AppClientCompilationParams & { onComplete?: OnApplicationComplete.NoOp }): AppClientMethodCallParams & AppClientCompilationParams & { onComplete?: OnApplicationComplete.NoOp } {
        return {
          ...params,
...
export class NfdInstanceFactory {
  ...
  readonly params = {
    ...
    create: {
       ...
       */
      createApplication: (params: CallParams<NfdInstanceArgs['obj']['createApplication(string,address,address,uint64,uint64,address,uint64,address,uint64,uint64,address)void'] | NfdInstanceArgs['tuple']['createApplication(string,address,address,uint64,uint64,address,uint64,address,uint64,uint64,address)void']> & AppClientCompilationParams & CreateSchema & { onComplete?: OnApplicationComplete.NoOp }) => {
  ...
  readonly send = {
    ...
    create: {
       ...
       */
      createApplication: async (params: CallParams<NfdInstanceArgs['obj']['createApplication(string,address,address,uint64,uint64,address,uint64,address,uint64,uint64,address)void'] | NfdInstanceArgs['tuple']['createApplication(string,address,address,uint64,uint64,address,uint64,address,uint64,uint64,address)void']> & AppClientCompilationParams & CreateSchema & SendParams & { onComplete?: OnApplicationComplete.NoOp }) => {
...
export class NfdInstanceClient {
  ...
  readonly params = {
    ...
    update: {
       ...
       */
      updateApplication: (params: CallParams<NfdInstanceArgs['obj']['updateApplication(string)void'] | NfdInstanceArgs['tuple']['updateApplication(string)void']> & AppClientCompilationParams & { onComplete?: OnApplicationComplete.UpdateApplication }) => {
  ...
  readonly send = {
    ...
    update: {
       ...
       */
      updateApplication: async (params: CallParams<NfdInstanceArgs['obj']['updateApplication(string)void'] | NfdInstanceArgs['tuple']['updateApplication(string)void']> & AppClientCompilationParams & SendParams & { onComplete?: OnApplicationComplete.UpdateApplication }) => {
