...
export type NfdInstanceCreateCallParams =
  | Expand<
      CallParams<
        | NfdInstanceArgs['obj']['createApplication(string,address,address,uint64,uint64,address,uint64,address,uint64,uint64,address)void']
        | NfdInstanceArgs['tuple']['createApplication(string,address,address,uint64,uint64,address,uint64,address,uint64,uint64,address)void']
      > & { method: 'createApplication' } & { onComplete?: OnApplicationComplete.NoOp } & CreateSchema
    >
  | Expand<
      CallParams<
        | NfdInstanceArgs['obj']['createApplication(string,address,address,uint64,uint64,address,uint64,address,uint64,uint64,address)void']
...
export type NfdInstanceUpdateCallParams =
  | Expand<
      CallParams<NfdInstanceArgs['obj']['updateApplication(string)void'] | NfdInstanceArgs['tuple']['updateApplication(string)void']> & {
 ...
 */
export type NfdInstanceDeployParams = Expand<
...
export abstract class NfdInstanceParamsFactory {
        ...
        return {
          ...
          args: Array.isArray(params.args)
            ...
            : [
                ...
                params.args.seller,
                params.args.buyer,
                params.args.purchaseAmount,
                params.args.expTime,
                params.args.commission1Addr,
                params.args.commission1Pct,
                params.args.commission2Addr,
                params.args.commission2Pct,
                params.args.segmentRootAppId,
                params.args.segmentRootCommissionAddr,
              ],
        }
      },
    }
  ...
  static get update() {
    return {
      ...
      updateApplication(
        params: CallParams<
          NfdInstanceArgs['obj']['updateApplication(string)void'] | NfdInstanceArgs['tuple']['updateApplication(string)void']
        > &
          AppClientCompilationParams,
  ...
  public async deploy(params: NfdInstanceDeployParams = {}) {
    const result = await this.appFactory.deploy({
      ...
      createParams: params.createParams?.method
        ? NfdInstanceParamsFactory.create._resolveByMethod(params.createParams)
        : params.createParams
          ? (params.createParams as NfdInstanceCreateCallParams & { args: Uint8Array[] })
          : undefined,
      updateParams: params.updateParams?.method
        ? NfdInstanceParamsFactory.update._resolveByMethod(params.updateParams)
        : params.updateParams
          ? (params.updateParams as NfdInstanceUpdateCallParams & { args: Uint8Array[] })
          : undefined,
    })
        ...
        return {
          result: {
            ...
            return: result.result.return as unknown as
              | undefined
              | NfdInstanceReturns['createApplication(string,address,address,uint64,uint64,address,uint64,address,uint64,uint64,address)void'],
          },
          appClient: new NfdInstanceClient(result.appClient),
        }
      },
    },
  }
  ...
  readonly update: {
    ...
    updateApplication(
      params?: CallParams<
        NfdInstanceArgs['obj']['updateApplication(string)void'] | NfdInstanceArgs['tuple']['updateApplication(string)void']
      >,
    ): NfdInstanceComposer<[...TReturns, NfdInstanceReturns['updateApplication(string)void'] | undefined]>
  }
