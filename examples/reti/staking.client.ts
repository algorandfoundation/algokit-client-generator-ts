...
export type ImportUsersPatrickbDevGitRepsRetiContractsContractsStakingPoolAlgoStakedInfo = {
  account: address,
  balance: uint64,
...
export type StakingPoolTypes = {
  ...
  methods:
    ...
    & Record<'getStakerInfo(address)(address,uint64,uint64,uint64,uint64)' | 'getStakerInfo', {
       ...
       */
      returns: ImportUsersPatrickbDevGitRepsRetiContractsContractsStakingPoolAlgoStakedInfo
    }>
