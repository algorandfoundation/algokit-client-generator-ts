...
export type ImportUsersPatrickbDevGitRepsRetiContractsContractsValidatorConfigsAlgoMbrAmounts = {
...
export type ImportUsersPatrickbDevGitRepsRetiContractsContractsValidatorConfigsAlgoConstraints = {
...
export type ImportUsersPatrickbDevGitRepsRetiContractsContractsValidatorConfigsAlgoValidatorConfig = {
  id: uint64,
  owner: address,
  manager: address,
  nfdForInfo: uint64,
...
export type ImportUsersPatrickbDevGitRepsRetiContractsContractsValidatorConfigsAlgoValidatorCurState = {
  numPools: uint16,
  totalStakers: uint64,
  totalAlgoStaked: uint64,
  rewardTokenHeldBack: uint64
...
export type ImportUsersPatrickbDevGitRepsRetiContractsContractsValidatorConfigsAlgoPoolInfo = {
  poolAppId: uint64,
  totalStakers: uint16,
  totalAlgoStaked: uint64
}

export type ImportUsersPatrickbDevGitRepsRetiContractsContractsValidatorConfigsAlgoValidatorPoolKey = {
  id: uint64,
  poolId: uint64,
  poolAppId: uint64
}

export type ImportUsersPatrickbDevGitRepsRetiContractsContractsValidatorConfigsAlgoPoolTokenPayoutRatio = {
  poolPctOfWhole: uint64[],
  updatedForPayout: uint64
}

export type ImportUsersPatrickbDevGitRepsRetiContractsContractsValidatorConfigsAlgoNodePoolAssignmentConfig = {
  nodes: [uint64[]][]
}
...
export type ValidatorRegistryTypes = {
  ...
  methods:
    ...
    & Record<'getMbrAmounts()(uint64,uint64,uint64,uint64)' | 'getMbrAmounts', {
      ...
      argsTuple: []
      returns: ImportUsersPatrickbDevGitRepsRetiContractsContractsValidatorConfigsAlgoMbrAmounts
    }>
    & Record<'getProtocolConstraints()(uint64,uint64,uint64,uint64,uint64,uint64,uint64,uint64,uint64,uint64,uint64)' | 'getProtocolConstraints', {
      ...
      argsTuple: []
      returns: ImportUsersPatrickbDevGitRepsRetiContractsContractsValidatorConfigsAlgoConstraints
    }>
    ...
    & Record<'getValidatorConfig(uint64)(uint64,address,address,uint64,uint8,address,uint64[4],uint64,uint64,uint64,uint32,uint32,address,uint64,uint64,uint8,uint64,uint64)' | 'getValidatorConfig', {
      ...
      returns: ImportUsersPatrickbDevGitRepsRetiContractsContractsValidatorConfigsAlgoValidatorConfig
    }>
    & Record<'getValidatorState(uint64)(uint16,uint64,uint64,uint64)' | 'getValidatorState', {
      ...
      argsTuple: [validatorId: bigint | number]
      returns: ImportUsersPatrickbDevGitRepsRetiContractsContractsValidatorConfigsAlgoValidatorCurState
    }>
    ...
    & Record<'getPoolInfo((uint64,uint64,uint64))(uint64,uint16,uint64)' | 'getPoolInfo', {
      argsObj: {
        poolKey: ImportUsersPatrickbDevGitRepsRetiContractsContractsValidatorConfigsAlgoValidatorPoolKey
      }
      argsTuple: [poolKey: ImportUsersPatrickbDevGitRepsRetiContractsContractsValidatorConfigsAlgoValidatorPoolKey]
      returns: ImportUsersPatrickbDevGitRepsRetiContractsContractsValidatorConfigsAlgoPoolInfo
    }>
    ...
    & Record<'getTokenPayoutRatio(uint64)(uint64[24],uint64)' | 'getTokenPayoutRatio', {
      ...
      argsTuple: [validatorId: bigint | number]
      returns: ImportUsersPatrickbDevGitRepsRetiContractsContractsValidatorConfigsAlgoPoolTokenPayoutRatio
    }>
    & Record<'getNodePoolAssignments(uint64)((uint64[3])[8])' | 'getNodePoolAssignments', {
      ...
      argsTuple: [validatorId: bigint | number]
      returns: ImportUsersPatrickbDevGitRepsRetiContractsContractsValidatorConfigsAlgoNodePoolAssignmentConfig
    }>
    ...
    & Record<'addValidator(pay,string,(uint64,address,address,uint64,uint8,address,uint64[4],uint64,uint64,uint64,uint32,uint32,address,uint64,uint64,uint8,uint64,uint64))uint64' | 'addValidator', {
      argsObj: {
         ...
         */
        config: ImportUsersPatrickbDevGitRepsRetiContractsContractsValidatorConfigsAlgoValidatorConfig
      }
      argsTuple: [mbrPayment: AppMethodCallTransactionArgument, nfdName: string, config: ImportUsersPatrickbDevGitRepsRetiContractsContractsValidatorConfigsAlgoValidatorConfig]
      /**
       * uint64 validator id
       */
      returns: bigint
    ...
    & Record<'addPool(pay,uint64,uint64)(uint64,uint64,uint64)' | 'addPool', {
       ...
       */
      returns: ImportUsersPatrickbDevGitRepsRetiContractsContractsValidatorConfigsAlgoValidatorPoolKey
    }>
    ...
    & Record<'stakeUpdatedViaRewards((uint64,uint64,uint64),uint64,uint64,uint64,uint64)void' | 'stakeUpdatedViaRewards', {
      ...
      argsTuple: [poolKey: ImportUsersPatrickbDevGitRepsRetiContractsContractsValidatorConfigsAlgoValidatorPoolKey, algoToAdd: bigint | number, rewardTokenAmountReserved: bigint | number, validatorCommission: bigint | number, saturatedBurnToFeeSink: bigint | number]
      returns: void
    }>
    & Record<'stakeRemoved((uint64,uint64,uint64),address,uint64,uint64,bool)void' | 'stakeRemoved', {
      ...
      argsTuple: [poolKey: ImportUsersPatrickbDevGitRepsRetiContractsContractsValidatorConfigsAlgoValidatorPoolKey, staker: string, amountRemoved: bigint | number, rewardRemoved: bigint | number, stakerRemoved: boolean]
      returns: void
    }>
