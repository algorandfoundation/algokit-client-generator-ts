...
export type ValidatorInfo = {
  config: {
    ...
    entryGatingAddress: string | Address,
    ...
    validatorCommissionAddress: string | Address,
 ...
 */
export function ValidatorInfoFromTuple(abiTuple: [[bigint, string | Address, string | Address, bigint, number, string | Address, [bigint, bigint, bigint, bigint], bigint, bigint, bigint, number, number, string | Address, bigint, bigint, number, bigint, bigint], [number, bigint, bigint, bigint], [[bigint, number, bigint], [bigint, number, bigint], [bigint, number, bigint], [bigint, number, bigint], [bigint, number, bigint], [bigint, number, bigint], [bigint, number, bigint], [bigint, number, bigint], [bigint, number, bigint], [bigint, number, bigint], [bigint, number, bigint], [bigint, number, bigint], [bigint, number, bigint], [bigint, number, bigint], [bigint, number, bigint], [bigint, number, bigint], [bigint, number, bigint], [bigint, number, bigint], [bigint, number, bigint], [bigint, number, bigint], [bigint, number, bigint], [bigint, number, bigint], [bigint, number, bigint], [bigint, number, bigint]], [[bigint, bigint, bigint, bigint, bigint, bigint, bigint, bigint, bigint, bigint, bigint, bigint, bigint, bigint, bigint, bigint, bigint, bigint, bigint, bigint, bigint, bigint, bigint, bigint], bigint], [[[[bigint, bigint, bigint]], [[bigint, bigint, bigint]], [[bigint, bigint, bigint]], [[bigint, bigint, bigint]], [[bigint, bigint, bigint]], [[bigint, bigint, bigint]], [[bigint, bigint, bigint]], [[bigint, bigint, bigint]]]]]) {
 ...
 */
export function ValidatorConfigFromTuple(abiTuple: [bigint, string | Address, string | Address, bigint, number, string | Address, [bigint, bigint, bigint, bigint], bigint, bigint, bigint, number, number, string | Address, bigint, bigint, number, bigint, bigint]) {
...
export type ValidatorRegistryArgs = {
  ...
  obj: {
    ...
    'changeValidatorCommissionAddress(uint64,address)void': {
      validatorId: bigint | number
      commissionAddress: string | Address
    }
  ...
  tuple: {
    ...
    'doesStakerNeedToPayMBR(address)bool': [staker: string | Address]
    'getStakedPoolsForAccount(address)(uint64,uint64,uint64)[]': [staker: string | Address]
    ...
    'changeValidatorManager(uint64,address)void': [validatorId: bigint | number, manager: string | Address]
    ...
    'changeValidatorCommissionAddress(uint64,address)void': [validatorId: bigint | number, commissionAddress: string | Address]
    'changeValidatorRewardInfo(uint64,uint8,address,uint64[4],uint64,uint64)void': [validatorId: bigint | number, entryGatingType: bigint | number, entryGatingAddress: string | Address, entryGatingAssets: [bigint | number, bigint | number, bigint | number, bigint | number], gatingAssetMinBalance: bigint | number, rewardPerPayout: bigint | number]
    ...
    'stakeRemoved((uint64,uint64,uint64),address,uint64,uint64,bool)void': [poolKey: ValidatorPoolKey, staker: string | Address, amountRemoved: bigint | number, rewardRemoved: bigint | number, stakerRemoved: boolean]
    'findPoolForStaker(uint64,address,uint64)((uint64,uint64,uint64),bool,bool)': [validatorId: bigint | number, staker: string | Address, amountToStake: bigint | number]
    'movePoolToNode(uint64,uint64,uint64)void': [validatorId: bigint | number, poolAppId: bigint | number, nodeNum: bigint | number]
    'emptyTokenRewards(uint64,address)uint64': [validatorId: bigint | number, receiver: string | Address]
  }
}
...
export type ValidatorRegistryReturns = {
  ...
  'getValidatorOwnerAndManager(uint64)(address,address)': [string | Address, string | Address]
  ...
  state: {
    ...
    box: {
      ...
      maps: {
        ...
        stakerPoolSet: Map<string | Address, [[bigint, bigint, bigint], [bigint, bigint, bigint], [bigint, bigint, bigint], [bigint, bigint, bigint], [bigint, bigint, bigint], [bigint, bigint, bigint]]>
      }
    }
  }
}
  ...
  state = {
    ...
    box: {
      ...
      stakerPoolSet: {
         ...
         */
        getMap: async (): Promise<Map<string | Address, [[bigint, bigint, bigint], [bigint, bigint, bigint], [bigint, bigint, bigint], [bigint, bigint, bigint], [bigint, bigint, bigint], [bigint, bigint, bigint]]>> => { return (await this.appClient.state.box.getMap("stakerPoolSet")) as Map<string | Address, [[bigint, bigint, bigint], [bigint, bigint, bigint], [bigint, bigint, bigint], [bigint, bigint, bigint], [bigint, bigint, bigint], [bigint, bigint, bigint]]> },
        /**
         * Get a current value of the stakerPoolSet map by key from box state
         */
        value: async (key: string | Address): Promise<[[bigint, bigint, bigint], [bigint, bigint, bigint], [bigint, bigint, bigint], [bigint, bigint, bigint], [bigint, bigint, bigint], [bigint, bigint, bigint]] | undefined> => { return await this.appClient.state.box.getMapValue("stakerPoolSet", key) as [[bigint, bigint, bigint], [bigint, bigint, bigint], [bigint, bigint, bigint], [bigint, bigint, bigint], [bigint, bigint, bigint], [bigint, bigint, bigint]] | undefined },
      },
    },
  }
