...
export class ValidatorRegistryFactory {
  ...
  readonly send = {
    ...
    create: {
       ...
       */
      createApplication: async (params: Expand<CallParams<'createApplication()void'> & AppClientCompilationParams & CreateSchema & SendParams & {onComplete?: OnApplicationComplete.NoOpOC}> = {args: []}) => {
...
export class ValidatorRegistryClient {
  ...
  readonly send = {
     ...
     */
    initStakingContract: async (params: Expand<CallParams<'initStakingContract(uint64)void'> & SendParams & {onComplete?: OnApplicationComplete.NoOpOC}>) => {
     ...
     * @returns The call result
     */
    loadStakingContractData: async (params: Expand<CallParams<'loadStakingContractData(uint64,byte[])void'> & SendParams & {onComplete?: OnApplicationComplete.NoOpOC}>) => {
     ...
     * @returns The call result
     */
    finalizeStakingContract: async (params: Expand<CallParams<'finalizeStakingContract()void'> & SendParams & {onComplete?: OnApplicationComplete.NoOpOC}> = {args: []}) => {
     ...
     * @returns The call result
     */
    gas: async (params: Expand<CallParams<'gas()void'> & SendParams & {onComplete?: OnApplicationComplete.NoOpOC}> = {args: []}) => {
    ...
    * Returns the MBR amounts needed for various actions:
     ...
     * @returns The call result
     */
    getMbrAmounts: async (params: Expand<CallParams<'getMbrAmounts()(uint64,uint64,uint64,uint64)'> & SendParams & {onComplete?: OnApplicationComplete.NoOpOC}> = {args: []}) => {
     ...
     * @returns The call result
     */
    getProtocolConstraints: async (params: Expand<CallParams<'getProtocolConstraints()(uint64,uint64,uint64,uint64,uint64,uint64,uint64,uint64,uint64,uint64,uint64)'> & SendParams & {onComplete?: OnApplicationComplete.NoOpOC}> = {args: []}) => {
     ...
     * @returns The call result
     */
    getNumValidators: async (params: Expand<CallParams<'getNumValidators()uint64'> & SendParams & {onComplete?: OnApplicationComplete.NoOpOC}> = {args: []}) => {
     ...
     * @returns The call result
     */
    getValidatorConfig: async (params: Expand<CallParams<'getValidatorConfig(uint64)(uint64,address,address,uint64,uint8,address,uint64[4],uint64,uint64,uint64,uint32,uint32,address,uint64,uint64,uint8,uint64,uint64)'> & SendParams & {onComplete?: OnApplicationComplete.NoOpOC}>) => {
     ...
     * @returns The call result
     */
    getValidatorState: async (params: Expand<CallParams<'getValidatorState(uint64)(uint16,uint64,uint64,uint64)'> & SendParams & {onComplete?: OnApplicationComplete.NoOpOC}>) => {
     ...
     * @returns The call result
     */
    getValidatorOwnerAndManager: async (params: Expand<CallParams<'getValidatorOwnerAndManager(uint64)(address,address)'> & SendParams & {onComplete?: OnApplicationComplete.NoOpOC}>) => {
     ...
     * @returns The call result
     */
    getPools: async (params: Expand<CallParams<'getPools(uint64)(uint64,uint16,uint64)[]'> & SendParams & {onComplete?: OnApplicationComplete.NoOpOC}>) => {
    ...
    * getPoolAppId is useful for callers to determine app to call for removing stake if they don't have staking or
     ...
     * @returns The call result
     */
    getPoolAppId: async (params: Expand<CallParams<'getPoolAppId(uint64,uint64)uint64'> & SendParams & {onComplete?: OnApplicationComplete.NoOpOC}>) => {
     ...
     * @returns The call result
     */
    getPoolInfo: async (params: Expand<CallParams<'getPoolInfo((uint64,uint64,uint64))(uint64,uint16,uint64)'> & SendParams & {onComplete?: OnApplicationComplete.NoOpOC}>) => {
    ...
    * Calculate the maximum stake per pool for a given validator.
     ...
     * @returns The call result
     */
    getCurMaxStakePerPool: async (params: Expand<CallParams<'getCurMaxStakePerPool(uint64)uint64'> & SendParams & {onComplete?: OnApplicationComplete.NoOpOC}>) => {
     ...
     * @returns The call result
     */
    doesStakerNeedToPayMbr: async (params: Expand<CallParams<'doesStakerNeedToPayMBR(address)bool'> & SendParams & {onComplete?: OnApplicationComplete.NoOpOC}>) => {
     ...
     * @returns The call result
     */
    getStakedPoolsForAccount: async (params: Expand<CallParams<'getStakedPoolsForAccount(address)(uint64,uint64,uint64)[]'> & SendParams & {onComplete?: OnApplicationComplete.NoOpOC}>) => {
    ...
    * Retrieves the token payout ratio for a given validator - returning the pool ratios of whole so that token
     ...
     * @returns The call result
     */
    getTokenPayoutRatio: async (params: Expand<CallParams<'getTokenPayoutRatio(uint64)(uint64[24],uint64)'> & SendParams & {onComplete?: OnApplicationComplete.NoOpOC}>) => {
     ...
     * @returns The call result
     */
    getNodePoolAssignments: async (params: Expand<CallParams<'getNodePoolAssignments(uint64)((uint64[3])[8])'> & SendParams & {onComplete?: OnApplicationComplete.NoOpOC}>) => {
     ...
     * @returns The call result
     */
    getNfdRegistryId: async (params: Expand<CallParams<'getNFDRegistryID()uint64'> & SendParams & {onComplete?: OnApplicationComplete.NoOpOC}> = {args: []}) => {
    ...
    * Adds a new validator
     ...
     */
    addValidator: async (params: Expand<CallParams<'addValidator(pay,string,(uint64,address,address,uint64,uint8,address,uint64[4],uint64,uint64,uint64,uint32,uint32,address,uint64,uint64,uint8,uint64,uint64))uint64'> & SendParams & {onComplete?: OnApplicationComplete.NoOpOC}>) => {
    ...
    * Changes the Validator manager for a specific Validator id.
     ...
     * @returns The call result
     */
    changeValidatorManager: async (params: Expand<CallParams<'changeValidatorManager(uint64,address)void'> & SendParams & {onComplete?: OnApplicationComplete.NoOpOC}>) => {
    ...
    * Updates the sunset information for a given validator.
     ...
     * @returns The call result
     */
    changeValidatorSunsetInfo: async (params: Expand<CallParams<'changeValidatorSunsetInfo(uint64,uint64,uint64)void'> & SendParams & {onComplete?: OnApplicationComplete.NoOpOC}>) => {
    ...
    * Changes the NFD for a validator in the validatorList contract.
     ...
     * @returns The call result
     */
    changeValidatorNfd: async (params: Expand<CallParams<'changeValidatorNFD(uint64,uint64,string)void'> & SendParams & {onComplete?: OnApplicationComplete.NoOpOC}>) => {
    ...
    * Change the commission address that validator rewards are sent to.
     ...
     * @returns The call result
     */
    changeValidatorCommissionAddress: async (params: Expand<CallParams<'changeValidatorCommissionAddress(uint64,address)void'> & SendParams & {onComplete?: OnApplicationComplete.NoOpOC}>) => {
    ...
    * Allow the additional rewards (gating entry, additional token rewards) information be changed at will.
     ...
     * @returns The call result
     */
    changeValidatorRewardInfo: async (params: Expand<CallParams<'changeValidatorRewardInfo(uint64,uint8,address,uint64[4],uint64,uint64)void'> & SendParams & {onComplete?: OnApplicationComplete.NoOpOC}>) => {
    ...
    * Adds a new pool to a validator's pool set, returning the 'key' to reference the pool in the future for staking, etc.
     ...
     */
    addPool: async (params: Expand<CallParams<'addPool(pay,uint64,uint64)(uint64,uint64,uint64)'> & SendParams & {onComplete?: OnApplicationComplete.NoOpOC}>) => {
     ...
     */
    addStake: async (params: Expand<CallParams<'addStake(pay,uint64,uint64)(uint64,uint64,uint64)'> & SendParams & {onComplete?: OnApplicationComplete.NoOpOC}>) => {
    ...
    * setTokenPayoutRatio is called by Staking Pool # 1 (ONLY) to ask the validator (us) to calculate the ratios
     ...
     */
    setTokenPayoutRatio: async (params: Expand<CallParams<'setTokenPayoutRatio(uint64)(uint64[24],uint64)'> & SendParams & {onComplete?: OnApplicationComplete.NoOpOC}>) => {
    ...
    * stakeUpdatedViaRewards is called by Staking pools to inform the validator (us) that a particular amount of total
     ...
     * @returns The call result
     */
    stakeUpdatedViaRewards: async (params: Expand<CallParams<'stakeUpdatedViaRewards((uint64,uint64,uint64),uint64,uint64,uint64,uint64)void'> & SendParams & {onComplete?: OnApplicationComplete.NoOpOC}>) => {
    ...
    * stakeRemoved is called by Staking pools to inform the validator (us) that a particular amount of total stake has been removed
     ...
     * @returns The call result
     */
    stakeRemoved: async (params: Expand<CallParams<'stakeRemoved((uint64,uint64,uint64),address,uint64,uint64,bool)void'> & SendParams & {onComplete?: OnApplicationComplete.NoOpOC}>) => {
    ...
    * @returns The call result: ValidatorPoolKey, boolean, boolean - The pool for the staker, true/false on whether the staker is 'new'
     ...
     */
    findPoolForStaker: async (params: Expand<CallParams<'findPoolForStaker(uint64,address,uint64)((uint64,uint64,uint64),bool,bool)'> & SendParams & {onComplete?: OnApplicationComplete.NoOpOC}>) => {
    ...
    * Find the specified pool (in any node number) and move it to the specified node.
     ...
     * @returns The call result
     */
    movePoolToNode: async (params: Expand<CallParams<'movePoolToNode(uint64,uint64,uint64)void'> & SendParams & {onComplete?: OnApplicationComplete.NoOpOC}>) => {
    ...
    * Sends the reward tokens held in pool 1 to specified receiver.
     ...
     */
    emptyTokenRewards: async (params: Expand<CallParams<'emptyTokenRewards(uint64,address)uint64'> & SendParams & {onComplete?: OnApplicationComplete.NoOpOC}>) => {
