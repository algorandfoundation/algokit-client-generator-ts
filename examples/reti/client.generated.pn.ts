...
/**
 * Converts the ABI return of a ValidatorInfo to the struct representation
 */
export function ValidatorInfoABIReturnFormatter(returnValue: ABIReturn | undefined) {
  if (returnValue === undefined) return undefined
  if (returnValue.decodeError) throw returnValue.decodeError
  return getABIStructFromABITuple<ValidatorInfo>(returnValue.returnValue as ABIValue[],
    {config: {id: 'uint64', owner: 'address', manager: 'address', nfdForInfo: 'uint64', entryGatingType: 'uint8', entryGatingAddress: 'address', entryGatingAssets: 'uint64[4]', gatingAssetMinBalance: 'uint64', rewardTokenId: 'uint64', rewardPerPayout: 'uint64', epochRoundLength: 'uint32', percentToValidator: 'uint32', validatorCommissionAddress: 'address', minEntryStake: 'uint64', maxAlgoPerPool: 'uint64', poolsPerNode: 'uint8', sunsettingOn: 'uint64', sunsettingTo: 'uint64'}, state: {numPools: 'uint16', totalStakers: 'uint64', totalAlgoStaked: 'uint64', rewardTokenHeldBack: 'uint64'}, pools: '(uint64,uint16,uint64)[24]', tokenPayoutRatio: {poolPctOfWhole: 'uint64[24]', updatedForPayout: 'uint64'}, nodePoolAssignments: {nodes: '(uint64[3])[8]'}}
  )
}
/**
 * Converts a ValidatorInfo to an ABI tuple
 */
export function ValidatorInfoToABITuple(struct: ValidatorInfo) {
...
/**
 * Converts the ABI return of a MbrAmounts to the struct representation
 */
export function MbrAmountsABIReturnFormatter(returnValue: ABIReturn | undefined) {
  if (returnValue === undefined) return undefined
  if (returnValue.decodeError) throw returnValue.decodeError
  return getABIStructFromABITuple<MbrAmounts>(returnValue.returnValue as ABIValue[],
    {addValidatorMbr: 'uint64', addPoolMbr: 'uint64', poolInitMbr: 'uint64', addStakerMbr: 'uint64'}
  )
}
/**
 * Converts a MbrAmounts to an ABI tuple
 */
export function MbrAmountsToABITuple(struct: MbrAmounts) {
  return getABITupleFromABIStruct(struct,
    {addValidatorMbr: 'uint64', addPoolMbr: 'uint64', poolInitMbr: 'uint64', addStakerMbr: 'uint64'}
  )
}
...
/**
 * Converts the ABI return of a Constraints to the struct representation
 */
export function ConstraintsABIReturnFormatter(returnValue: ABIReturn | undefined) {
  if (returnValue === undefined) return undefined
  if (returnValue.decodeError) throw returnValue.decodeError
  return getABIStructFromABITuple<Constraints>(returnValue.returnValue as ABIValue[],
    {epochPayoutRoundsMin: 'uint64', epochPayoutRoundsMax: 'uint64', minPctToValidatorWFourDecimals: 'uint64', maxPctToValidatorWFourDecimals: 'uint64', minEntryStake: 'uint64', maxAlgoPerPool: 'uint64', maxAlgoPerValidator: 'uint64', amtConsideredSaturated: 'uint64', maxNodes: 'uint64', maxPoolsPerNode: 'uint64', maxStakersPerPool: 'uint64'}
  )
}
/**
 * Converts a Constraints to an ABI tuple
 */
export function ConstraintsToABITuple(struct: Constraints) {
  return getABITupleFromABIStruct(struct,
    {epochPayoutRoundsMin: 'uint64', epochPayoutRoundsMax: 'uint64', minPctToValidatorWFourDecimals: 'uint64', maxPctToValidatorWFourDecimals: 'uint64', minEntryStake: 'uint64', maxAlgoPerPool: 'uint64', maxAlgoPerValidator: 'uint64', amtConsideredSaturated: 'uint64', maxNodes: 'uint64', maxPoolsPerNode: 'uint64', maxStakersPerPool: 'uint64'}
  )
}
...
/**
 * Converts the ABI return of a ValidatorConfig to the struct representation
 */
export function ValidatorConfigABIReturnFormatter(returnValue: ABIReturn | undefined) {
  if (returnValue === undefined) return undefined
  if (returnValue.decodeError) throw returnValue.decodeError
  return getABIStructFromABITuple<ValidatorConfig>(returnValue.returnValue as ABIValue[],
    {id: 'uint64', owner: 'address', manager: 'address', nfdForInfo: 'uint64', entryGatingType: 'uint8', entryGatingAddress: 'address', entryGatingAssets: 'uint64[4]', gatingAssetMinBalance: 'uint64', rewardTokenId: 'uint64', rewardPerPayout: 'uint64', epochRoundLength: 'uint32', percentToValidator: 'uint32', validatorCommissionAddress: 'address', minEntryStake: 'uint64', maxAlgoPerPool: 'uint64', poolsPerNode: 'uint8', sunsettingOn: 'uint64', sunsettingTo: 'uint64'}
  )
}
/**
 * Converts a ValidatorConfig to an ABI tuple
 */
export function ValidatorConfigToABITuple(struct: ValidatorConfig) {
  return getABITupleFromABIStruct(struct,
    {id: 'uint64', owner: 'address', manager: 'address', nfdForInfo: 'uint64', entryGatingType: 'uint8', entryGatingAddress: 'address', entryGatingAssets: 'uint64[4]', gatingAssetMinBalance: 'uint64', rewardTokenId: 'uint64', rewardPerPayout: 'uint64', epochRoundLength: 'uint32', percentToValidator: 'uint32', validatorCommissionAddress: 'address', minEntryStake: 'uint64', maxAlgoPerPool: 'uint64', poolsPerNode: 'uint8', sunsettingOn: 'uint64', sunsettingTo: 'uint64'}
  )
}
...
/**
 * Converts the ABI return of a ValidatorCurState to the struct representation
 */
export function ValidatorCurStateABIReturnFormatter(returnValue: ABIReturn | undefined) {
  if (returnValue === undefined) return undefined
  if (returnValue.decodeError) throw returnValue.decodeError
  return getABIStructFromABITuple<ValidatorCurState>(returnValue.returnValue as ABIValue[],
    {numPools: 'uint16', totalStakers: 'uint64', totalAlgoStaked: 'uint64', rewardTokenHeldBack: 'uint64'}
  )
}
/**
 * Converts a ValidatorCurState to an ABI tuple
 */
export function ValidatorCurStateToABITuple(struct: ValidatorCurState) {
  return getABITupleFromABIStruct(struct,
    {numPools: 'uint16', totalStakers: 'uint64', totalAlgoStaked: 'uint64', rewardTokenHeldBack: 'uint64'}
  )
}
...
/**
 * Converts the ABI return of a PoolInfo to the struct representation
 */
export function PoolInfoABIReturnFormatter(returnValue: ABIReturn | undefined) {
  if (returnValue === undefined) return undefined
  if (returnValue.decodeError) throw returnValue.decodeError
  return getABIStructFromABITuple<PoolInfo>(returnValue.returnValue as ABIValue[],
    {poolAppId: 'uint64', totalStakers: 'uint16', totalAlgoStaked: 'uint64'}
  )
}
/**
 * Converts a PoolInfo to an ABI tuple
 */
export function PoolInfoToABITuple(struct: PoolInfo) {
  return getABITupleFromABIStruct(struct,
    {poolAppId: 'uint64', totalStakers: 'uint16', totalAlgoStaked: 'uint64'}
  )
}
...
/**
 * Converts the ABI return of a ValidatorPoolKey to the struct representation
 */
export function ValidatorPoolKeyABIReturnFormatter(returnValue: ABIReturn | undefined) {
  if (returnValue === undefined) return undefined
  if (returnValue.decodeError) throw returnValue.decodeError
  return getABIStructFromABITuple<ValidatorPoolKey>(returnValue.returnValue as ABIValue[],
    {id: 'uint64', poolId: 'uint64', poolAppId: 'uint64'}
  )
}
/**
 * Converts a ValidatorPoolKey to an ABI tuple
 */
export function ValidatorPoolKeyToABITuple(struct: ValidatorPoolKey) {
  return getABITupleFromABIStruct(struct,
    {id: 'uint64', poolId: 'uint64', poolAppId: 'uint64'}
  )
}
...
/**
 * Converts the ABI return of a PoolTokenPayoutRatio to the struct representation
 */
export function PoolTokenPayoutRatioABIReturnFormatter(returnValue: ABIReturn | undefined) {
  if (returnValue === undefined) return undefined
  if (returnValue.decodeError) throw returnValue.decodeError
  return getABIStructFromABITuple<PoolTokenPayoutRatio>(returnValue.returnValue as ABIValue[],
    {poolPctOfWhole: 'uint64[24]', updatedForPayout: 'uint64'}
  )
}
/**
 * Converts a PoolTokenPayoutRatio to an ABI tuple
 */
export function PoolTokenPayoutRatioToABITuple(struct: PoolTokenPayoutRatio) {
  return getABITupleFromABIStruct(struct,
    {poolPctOfWhole: 'uint64[24]', updatedForPayout: 'uint64'}
  )
}
...
/**
 * Converts the ABI return of a NodePoolAssignmentConfig to the struct representation
 */
export function NodePoolAssignmentConfigABIReturnFormatter(returnValue: ABIReturn | undefined) {
  if (returnValue === undefined) return undefined
  if (returnValue.decodeError) throw returnValue.decodeError
  return getABIStructFromABITuple<NodePoolAssignmentConfig>(returnValue.returnValue as ABIValue[],
    {nodes: '(uint64[3])[8]'}
  )
}
/**
 * Converts a NodePoolAssignmentConfig to an ABI tuple
 */
export function NodePoolAssignmentConfigToABITuple(struct: NodePoolAssignmentConfig) {
  return getABITupleFromABIStruct(struct,
    {nodes: '(uint64[3])[8]'}
  )
}
...
export abstract class ValidatorRegistryParamsFactory {
  ...
  static getMbrAmounts(params: CallParams<'getMbrAmounts()(uint64,uint64,uint64,uint64)'> & CallOnComplete): AppClientMethodCallParams & CallOnComplete {
    return {
      ...
      args: Array.isArray(params.args) ? params.args : [],
      returnValueFormatter: MbrAmountsABIReturnFormatter
    }
  }
  /**
  ...
  static getProtocolConstraints(params: CallParams<'getProtocolConstraints()(uint64,uint64,uint64,uint64,uint64,uint64,uint64,uint64,uint64,uint64,uint64)'> & CallOnComplete): AppClientMethodCallParams & CallOnComplete {
    return {
      ...
      args: Array.isArray(params.args) ? params.args : [],
      returnValueFormatter: ConstraintsABIReturnFormatter
    }
  }
  /**
  ...
  static getValidatorConfig(params: CallParams<'getValidatorConfig(uint64)(uint64,address,address,uint64,uint8,address,uint64[4],uint64,uint64,uint64,uint32,uint32,address,uint64,uint64,uint8,uint64,uint64)'> & CallOnComplete): AppClientMethodCallParams & CallOnComplete {
    return {
      ...
      returnValueFormatter: ValidatorConfigABIReturnFormatter
    }
  }
  /**
  ...
  static getValidatorState(params: CallParams<'getValidatorState(uint64)(uint16,uint64,uint64,uint64)'> & CallOnComplete): AppClientMethodCallParams & CallOnComplete {
    return {
      ...
      args: Array.isArray(params.args) ? params.args : [params.args.validatorId],
      returnValueFormatter: ValidatorCurStateABIReturnFormatter
    }
  }
  /**
  ...
  static getPoolInfo(params: CallParams<'getPoolInfo((uint64,uint64,uint64))(uint64,uint16,uint64)'> & CallOnComplete): AppClientMethodCallParams & CallOnComplete {
    return {
      ...
      args: Array.isArray(params.args) ? params.args : [ValidatorPoolKeyToABITuple(params.args.poolKey)],
      returnValueFormatter: PoolInfoABIReturnFormatter
    }
  }
  /**
  ...
  static getTokenPayoutRatio(params: CallParams<'getTokenPayoutRatio(uint64)(uint64[24],uint64)'> & CallOnComplete): AppClientMethodCallParams & CallOnComplete {
    return {
      ...
      args: Array.isArray(params.args) ? params.args : [params.args.validatorId],
      returnValueFormatter: PoolTokenPayoutRatioABIReturnFormatter
    }
  }
  /**
  ...
  static getNodePoolAssignments(params: CallParams<'getNodePoolAssignments(uint64)((uint64[3])[8])'> & CallOnComplete): AppClientMethodCallParams & CallOnComplete {
    return {
      ...
      args: Array.isArray(params.args) ? params.args : [params.args.validatorId],
      returnValueFormatter: NodePoolAssignmentConfigABIReturnFormatter
    }
  }
  /**
  ...
  static addValidator(params: CallParams<'addValidator(pay,string,(uint64,address,address,uint64,uint8,address,uint64[4],uint64,uint64,uint64,uint32,uint32,address,uint64,uint64,uint8,uint64,uint64))uint64'> & CallOnComplete): AppClientMethodCallParams & CallOnComplete {
    return {
      ...
      args: Array.isArray(params.args) ? params.args : [params.args.mbrPayment, params.args.nfdName, ValidatorConfigToABITuple(params.args.config)],
    }
  }
  /**
  ...
  static addPool(params: CallParams<'addPool(pay,uint64,uint64)(uint64,uint64,uint64)'> & CallOnComplete): AppClientMethodCallParams & CallOnComplete {
    return {
      ...
      returnValueFormatter: ValidatorPoolKeyABIReturnFormatter
    }
  }
  /**
  ...
  static stakeUpdatedViaRewards(params: CallParams<'stakeUpdatedViaRewards((uint64,uint64,uint64),uint64,uint64,uint64,uint64)void'> & CallOnComplete): AppClientMethodCallParams & CallOnComplete {
    return {
      ...
      args: Array.isArray(params.args) ? params.args : [ValidatorPoolKeyToABITuple(params.args.poolKey), params.args.algoToAdd, params.args.rewardTokenAmountReserved, params.args.validatorCommission, params.args.saturatedBurnToFeeSink],
    }
  }
  /**
  ...
  static stakeRemoved(params: CallParams<'stakeRemoved((uint64,uint64,uint64),address,uint64,uint64,bool)void'> & CallOnComplete): AppClientMethodCallParams & CallOnComplete {
    return {
      ...
      args: Array.isArray(params.args) ? params.args : [ValidatorPoolKeyToABITuple(params.args.poolKey), params.args.staker, params.args.amountRemoved, params.args.rewardRemoved, params.args.stakerRemoved],
    }
  }
  /**
...
export class ValidatorRegistryFactory {
  ...
  public async getAppClientByCreatorAddressAndName(
    ...
    return new ValidatorRegistryClient(await this.appFactory.getAppClientByCreatorAddressAndName(params))
  }
  ...
  public async deploy(params: ValidatorRegistryDeployParams = {}) {
    ...
    return { result: result.result, app: new ValidatorRegistryClient(result.app) }
  }
      ...
      get create() {
        return {
          ...
          async createApplication(params: Expand<CallParams<'createApplication()void'> & AppClientCompilationParams & CreateSchema & ExecuteParams & {onComplete?: OnApplicationComplete.NoOpOC}> = {args: []}) {
            const result = await $this.appFactory.create(ValidatorRegistryParamsFactory.create.createApplication(params))
            return { result: { ...result.result, return: result.result.return as undefined | MethodReturn<'createApplication()void'> }, app: new ValidatorRegistryClient(result.app) }
          },
        }
      },
...
export class ValidatorRegistryClient {
  ...
  decodeReturnValue<TSignature extends ValidatorRegistryNonVoidMethodSignatures>(method: TSignature, returnValue: ABIReturn | undefined) {
    return returnValue !== undefined ? getArc56ReturnValue<MethodReturn<TSignature>>(returnValue, this.appClient.getABIMethod(method), {ValidatorInfo: {config: {id: 'uint64', owner: 'address', manager: 'address', nfdForInfo: 'uint64', entryGatingType: 'uint8', entryGatingAddress: 'address', entryGatingAssets: 'uint64[4]', gatingAssetMinBalance: 'uint64', rewardTokenId: 'uint64', rewardPerPayout: 'uint64', epochRoundLength: 'uint32', percentToValidator: 'uint32', validatorCommissionAddress: 'address', minEntryStake: 'uint64', maxAlgoPerPool: 'uint64', poolsPerNode: 'uint8', sunsettingOn: 'uint64', sunsettingTo: 'uint64'}, state: {numPools: 'uint16', totalStakers: 'uint64', totalAlgoStaked: 'uint64', rewardTokenHeldBack: 'uint64'}, pools: '(uint64,uint16,uint64)[24]', tokenPayoutRatio: {poolPctOfWhole: 'uint64[24]', updatedForPayout: 'uint64'}, nodePoolAssignments: {nodes: '(uint64[3])[8]'}}, MbrAmounts: {addValidatorMbr: 'uint64', addPoolMbr: 'uint64', poolInitMbr: 'uint64', addStakerMbr: 'uint64'}, Constraints: {epochPayoutRoundsMin: 'uint64', epochPayoutRoundsMax: 'uint64', minPctToValidatorWFourDecimals: 'uint64', maxPctToValidatorWFourDecimals: 'uint64', minEntryStake: 'uint64', maxAlgoPerPool: 'uint64', maxAlgoPerValidator: 'uint64', amtConsideredSaturated: 'uint64', maxNodes: 'uint64', maxPoolsPerNode: 'uint64', maxStakersPerPool: 'uint64'}, ValidatorConfig: {id: 'uint64', owner: 'address', manager: 'address', nfdForInfo: 'uint64', entryGatingType: 'uint8', entryGatingAddress: 'address', entryGatingAssets: 'uint64[4]', gatingAssetMinBalance: 'uint64', rewardTokenId: 'uint64', rewardPerPayout: 'uint64', epochRoundLength: 'uint32', percentToValidator: 'uint32', validatorCommissionAddress: 'address', minEntryStake: 'uint64', maxAlgoPerPool: 'uint64', poolsPerNode: 'uint8', sunsettingOn: 'uint64', sunsettingTo: 'uint64'}, ValidatorCurState: {numPools: 'uint16', totalStakers: 'uint64', totalAlgoStaked: 'uint64', rewardTokenHeldBack: 'uint64'}, PoolInfo: {poolAppId: 'uint64', totalStakers: 'uint16', totalAlgoStaked: 'uint64'}, ValidatorPoolKey: {id: 'uint64', poolId: 'uint64', poolAppId: 'uint64'}, PoolTokenPayoutRatio: {poolPctOfWhole: 'uint64[24]', updatedForPayout: 'uint64'}, NodePoolAssignmentConfig: {nodes: '(uint64[3])[8]'}}) : undefined
  }
    ...
    return {
      ...
      get update() {
        return {
           ...
           */
          updateApplication(params: Expand<CallParams<'updateApplication()void'> & AppClientCompilationParams> = {args: []}) {
            return $this.appClient.transactions.update(ValidatorRegistryParamsFactory.update.updateApplication(params))
          },
        }
      },
       ...
       */
      initStakingContract(params: Expand<CallParams<'initStakingContract(uint64)void'> & {onComplete?: OnApplicationComplete.NoOpOC}>) {
        return $this.appClient.transactions.call(ValidatorRegistryParamsFactory.initStakingContract(params))
      },
      /**
       * Makes a call to the ValidatorRegistry smart contract using the loadStakingContractData(uint64,byte[])void ABI method.
       *
       ...
       */
      loadStakingContractData(params: Expand<CallParams<'loadStakingContractData(uint64,byte[])void'> & {onComplete?: OnApplicationComplete.NoOpOC}>) {
        return $this.appClient.transactions.call(ValidatorRegistryParamsFactory.loadStakingContractData(params))
      },
      /**
       * Makes a call to the ValidatorRegistry smart contract using the finalizeStakingContract()void ABI method.
       *
       ...
       */
      finalizeStakingContract(params: Expand<CallParams<'finalizeStakingContract()void'> & {onComplete?: OnApplicationComplete.NoOpOC}> = {args: []}) {
        return $this.appClient.transactions.call(ValidatorRegistryParamsFactory.finalizeStakingContract(params))
      },
      /**
       * Makes a call to the ValidatorRegistry smart contract using the gas()void ABI method.
       *
       ...
       */
      gas(params: Expand<CallParams<'gas()void'> & {onComplete?: OnApplicationComplete.NoOpOC}> = {args: []}) {
        return $this.appClient.transactions.call(ValidatorRegistryParamsFactory.gas(params))
      },
      /**
       * Makes a call to the ValidatorRegistry smart contract using the getMbrAmounts()(uint64,uint64,uint64,uint64) ABI method.
       *
       ...
       */
      getMbrAmounts(params: Expand<CallParams<'getMbrAmounts()(uint64,uint64,uint64,uint64)'> & {onComplete?: OnApplicationComplete.NoOpOC}> = {args: []}) {
        return $this.appClient.transactions.call(ValidatorRegistryParamsFactory.getMbrAmounts(params))
      },
      /**
       * Makes a call to the ValidatorRegistry smart contract using the getProtocolConstraints()(uint64,uint64,uint64,uint64,uint64,uint64,uint64,uint64,uint64,uint64,uint64) ABI method.
       *
       ...
       */
      getProtocolConstraints(params: Expand<CallParams<'getProtocolConstraints()(uint64,uint64,uint64,uint64,uint64,uint64,uint64,uint64,uint64,uint64,uint64)'> & {onComplete?: OnApplicationComplete.NoOpOC}> = {args: []}) {
        return $this.appClient.transactions.call(ValidatorRegistryParamsFactory.getProtocolConstraints(params))
      },
      /**
       * Makes a call to the ValidatorRegistry smart contract using the getNumValidators()uint64 ABI method.
       *
       ...
       */
      getNumValidators(params: Expand<CallParams<'getNumValidators()uint64'> & {onComplete?: OnApplicationComplete.NoOpOC}> = {args: []}) {
        return $this.appClient.transactions.call(ValidatorRegistryParamsFactory.getNumValidators(params))
      },
      /**
       * Makes a call to the ValidatorRegistry smart contract using the getValidatorConfig(uint64)(uint64,address,address,uint64,uint8,address,uint64[4],uint64,uint64,uint64,uint32,uint32,address,uint64,uint64,uint8,uint64,uint64) ABI method.
       *
       ...
       */
      getValidatorConfig(params: Expand<CallParams<'getValidatorConfig(uint64)(uint64,address,address,uint64,uint8,address,uint64[4],uint64,uint64,uint64,uint32,uint32,address,uint64,uint64,uint8,uint64,uint64)'> & {onComplete?: OnApplicationComplete.NoOpOC}>) {
        return $this.appClient.transactions.call(ValidatorRegistryParamsFactory.getValidatorConfig(params))
      },
      /**
       * Makes a call to the ValidatorRegistry smart contract using the getValidatorState(uint64)(uint16,uint64,uint64,uint64) ABI method.
       *
       ...
       */
      getValidatorState(params: Expand<CallParams<'getValidatorState(uint64)(uint16,uint64,uint64,uint64)'> & {onComplete?: OnApplicationComplete.NoOpOC}>) {
        return $this.appClient.transactions.call(ValidatorRegistryParamsFactory.getValidatorState(params))
      },
      /**
       * Makes a call to the ValidatorRegistry smart contract using the getValidatorOwnerAndManager(uint64)(address,address) ABI method.
       *
       ...
       */
      getValidatorOwnerAndManager(params: Expand<CallParams<'getValidatorOwnerAndManager(uint64)(address,address)'> & {onComplete?: OnApplicationComplete.NoOpOC}>) {
        return $this.appClient.transactions.call(ValidatorRegistryParamsFactory.getValidatorOwnerAndManager(params))
      },
      /**
       * Makes a call to the ValidatorRegistry smart contract using the getPools(uint64)(uint64,uint16,uint64)[] ABI method.
       *
       ...
       */
      getPools(params: Expand<CallParams<'getPools(uint64)(uint64,uint16,uint64)[]'> & {onComplete?: OnApplicationComplete.NoOpOC}>) {
        return $this.appClient.transactions.call(ValidatorRegistryParamsFactory.getPools(params))
      },
      /**
       * Makes a call to the ValidatorRegistry smart contract using the getPoolAppId(uint64,uint64)uint64 ABI method.
       *
       ...
       */
      getPoolAppId(params: Expand<CallParams<'getPoolAppId(uint64,uint64)uint64'> & {onComplete?: OnApplicationComplete.NoOpOC}>) {
        return $this.appClient.transactions.call(ValidatorRegistryParamsFactory.getPoolAppId(params))
      },
      /**
       * Makes a call to the ValidatorRegistry smart contract using the getPoolInfo((uint64,uint64,uint64))(uint64,uint16,uint64) ABI method.
       *
       ...
       */
      getPoolInfo(params: Expand<CallParams<'getPoolInfo((uint64,uint64,uint64))(uint64,uint16,uint64)'> & {onComplete?: OnApplicationComplete.NoOpOC}>) {
        return $this.appClient.transactions.call(ValidatorRegistryParamsFactory.getPoolInfo(params))
      },
      /**
       * Makes a call to the ValidatorRegistry smart contract using the getCurMaxStakePerPool(uint64)uint64 ABI method.
       *
       ...
       */
      getCurMaxStakePerPool(params: Expand<CallParams<'getCurMaxStakePerPool(uint64)uint64'> & {onComplete?: OnApplicationComplete.NoOpOC}>) {
        return $this.appClient.transactions.call(ValidatorRegistryParamsFactory.getCurMaxStakePerPool(params))
      },
      /**
       * Makes a call to the ValidatorRegistry smart contract using the doesStakerNeedToPayMBR(address)bool ABI method.
       *
       ...
       */
      doesStakerNeedToPayMBR(params: Expand<CallParams<'doesStakerNeedToPayMBR(address)bool'> & {onComplete?: OnApplicationComplete.NoOpOC}>) {
        return $this.appClient.transactions.call(ValidatorRegistryParamsFactory.doesStakerNeedToPayMBR(params))
      },
      /**
       * Makes a call to the ValidatorRegistry smart contract using the getStakedPoolsForAccount(address)(uint64,uint64,uint64)[] ABI method.
       *
       ...
       */
      getStakedPoolsForAccount(params: Expand<CallParams<'getStakedPoolsForAccount(address)(uint64,uint64,uint64)[]'> & {onComplete?: OnApplicationComplete.NoOpOC}>) {
        return $this.appClient.transactions.call(ValidatorRegistryParamsFactory.getStakedPoolsForAccount(params))
      },
      /**
       * Makes a call to the ValidatorRegistry smart contract using the getTokenPayoutRatio(uint64)(uint64[24],uint64) ABI method.
       *
       ...
       */
      getTokenPayoutRatio(params: Expand<CallParams<'getTokenPayoutRatio(uint64)(uint64[24],uint64)'> & {onComplete?: OnApplicationComplete.NoOpOC}>) {
        return $this.appClient.transactions.call(ValidatorRegistryParamsFactory.getTokenPayoutRatio(params))
      },
      /**
       * Makes a call to the ValidatorRegistry smart contract using the getNodePoolAssignments(uint64)((uint64[3])[8]) ABI method.
       *
       ...
       */
      getNodePoolAssignments(params: Expand<CallParams<'getNodePoolAssignments(uint64)((uint64[3])[8])'> & {onComplete?: OnApplicationComplete.NoOpOC}>) {
        return $this.appClient.transactions.call(ValidatorRegistryParamsFactory.getNodePoolAssignments(params))
      },
      /**
       * Makes a call to the ValidatorRegistry smart contract using the getNFDRegistryID()uint64 ABI method.
       *
       ...
       */
      getNFDRegistryID(params: Expand<CallParams<'getNFDRegistryID()uint64'> & {onComplete?: OnApplicationComplete.NoOpOC}> = {args: []}) {
        return $this.appClient.transactions.call(ValidatorRegistryParamsFactory.getNFDRegistryID(params))
      },
      /**
       * Makes a call to the ValidatorRegistry smart contract using the addValidator(pay,string,(uint64,address,address,uint64,uint8,address,uint64[4],uint64,uint64,uint64,uint32,uint32,address,uint64,uint64,uint8,uint64,uint64))uint64 ABI method.
       *
       ...
       */
      addValidator(params: Expand<CallParams<'addValidator(pay,string,(uint64,address,address,uint64,uint8,address,uint64[4],uint64,uint64,uint64,uint32,uint32,address,uint64,uint64,uint8,uint64,uint64))uint64'> & {onComplete?: OnApplicationComplete.NoOpOC}>) {
        return $this.appClient.transactions.call(ValidatorRegistryParamsFactory.addValidator(params))
      },
      /**
       * Makes a call to the ValidatorRegistry smart contract using the changeValidatorManager(uint64,address)void ABI method.
       *
       ...
       */
      changeValidatorManager(params: Expand<CallParams<'changeValidatorManager(uint64,address)void'> & {onComplete?: OnApplicationComplete.NoOpOC}>) {
        return $this.appClient.transactions.call(ValidatorRegistryParamsFactory.changeValidatorManager(params))
      },
      /**
       * Makes a call to the ValidatorRegistry smart contract using the changeValidatorSunsetInfo(uint64,uint64,uint64)void ABI method.
       *
       ...
       */
      changeValidatorSunsetInfo(params: Expand<CallParams<'changeValidatorSunsetInfo(uint64,uint64,uint64)void'> & {onComplete?: OnApplicationComplete.NoOpOC}>) {
        return $this.appClient.transactions.call(ValidatorRegistryParamsFactory.changeValidatorSunsetInfo(params))
      },
      /**
       * Makes a call to the ValidatorRegistry smart contract using the changeValidatorNFD(uint64,uint64,string)void ABI method.
       *
       ...
       */
      changeValidatorNFD(params: Expand<CallParams<'changeValidatorNFD(uint64,uint64,string)void'> & {onComplete?: OnApplicationComplete.NoOpOC}>) {
        return $this.appClient.transactions.call(ValidatorRegistryParamsFactory.changeValidatorNFD(params))
      },
      /**
       * Makes a call to the ValidatorRegistry smart contract using the changeValidatorCommissionAddress(uint64,address)void ABI method.
       *
       ...
       */
      changeValidatorCommissionAddress(params: Expand<CallParams<'changeValidatorCommissionAddress(uint64,address)void'> & {onComplete?: OnApplicationComplete.NoOpOC}>) {
        return $this.appClient.transactions.call(ValidatorRegistryParamsFactory.changeValidatorCommissionAddress(params))
      },
      /**
       * Makes a call to the ValidatorRegistry smart contract using the changeValidatorRewardInfo(uint64,uint8,address,uint64[4],uint64,uint64)void ABI method.
       *
       ...
       */
      changeValidatorRewardInfo(params: Expand<CallParams<'changeValidatorRewardInfo(uint64,uint8,address,uint64[4],uint64,uint64)void'> & {onComplete?: OnApplicationComplete.NoOpOC}>) {
        return $this.appClient.transactions.call(ValidatorRegistryParamsFactory.changeValidatorRewardInfo(params))
      },
      /**
       * Makes a call to the ValidatorRegistry smart contract using the addPool(pay,uint64,uint64)(uint64,uint64,uint64) ABI method.
       *
       ...
       */
      addPool(params: Expand<CallParams<'addPool(pay,uint64,uint64)(uint64,uint64,uint64)'> & {onComplete?: OnApplicationComplete.NoOpOC}>) {
        return $this.appClient.transactions.call(ValidatorRegistryParamsFactory.addPool(params))
      },
      /**
       * Makes a call to the ValidatorRegistry smart contract using the addStake(pay,uint64,uint64)(uint64,uint64,uint64) ABI method.
       *
       ...
       */
      addStake(params: Expand<CallParams<'addStake(pay,uint64,uint64)(uint64,uint64,uint64)'> & {onComplete?: OnApplicationComplete.NoOpOC}>) {
        return $this.appClient.transactions.call(ValidatorRegistryParamsFactory.addStake(params))
      },
      /**
       * Makes a call to the ValidatorRegistry smart contract using the setTokenPayoutRatio(uint64)(uint64[24],uint64) ABI method.
       *
       ...
       */
      setTokenPayoutRatio(params: Expand<CallParams<'setTokenPayoutRatio(uint64)(uint64[24],uint64)'> & {onComplete?: OnApplicationComplete.NoOpOC}>) {
        return $this.appClient.transactions.call(ValidatorRegistryParamsFactory.setTokenPayoutRatio(params))
      },
      /**
       * Makes a call to the ValidatorRegistry smart contract using the stakeUpdatedViaRewards((uint64,uint64,uint64),uint64,uint64,uint64,uint64)void ABI method.
       *
       ...
       */
      stakeUpdatedViaRewards(params: Expand<CallParams<'stakeUpdatedViaRewards((uint64,uint64,uint64),uint64,uint64,uint64,uint64)void'> & {onComplete?: OnApplicationComplete.NoOpOC}>) {
        return $this.appClient.transactions.call(ValidatorRegistryParamsFactory.stakeUpdatedViaRewards(params))
      },
      /**
       * Makes a call to the ValidatorRegistry smart contract using the stakeRemoved((uint64,uint64,uint64),address,uint64,uint64,bool)void ABI method.
       *
       ...
       */
      stakeRemoved(params: Expand<CallParams<'stakeRemoved((uint64,uint64,uint64),address,uint64,uint64,bool)void'> & {onComplete?: OnApplicationComplete.NoOpOC}>) {
        return $this.appClient.transactions.call(ValidatorRegistryParamsFactory.stakeRemoved(params))
      },
      /**
       * Makes a call to the ValidatorRegistry smart contract using the findPoolForStaker(uint64,address,uint64)((uint64,uint64,uint64),bool,bool) ABI method.
       *
       ...
       */
      findPoolForStaker(params: Expand<CallParams<'findPoolForStaker(uint64,address,uint64)((uint64,uint64,uint64),bool,bool)'> & {onComplete?: OnApplicationComplete.NoOpOC}>) {
        return $this.appClient.transactions.call(ValidatorRegistryParamsFactory.findPoolForStaker(params))
      },
      /**
       * Makes a call to the ValidatorRegistry smart contract using the movePoolToNode(uint64,uint64,uint64)void ABI method.
       *
       ...
       */
      movePoolToNode(params: Expand<CallParams<'movePoolToNode(uint64,uint64,uint64)void'> & {onComplete?: OnApplicationComplete.NoOpOC}>) {
        return $this.appClient.transactions.call(ValidatorRegistryParamsFactory.movePoolToNode(params))
      },
      /**
       * Makes a call to the ValidatorRegistry smart contract using the emptyTokenRewards(uint64,address)uint64 ABI method.
       *
       ...
       */
      emptyTokenRewards(params: Expand<CallParams<'emptyTokenRewards(uint64,address)uint64'> & {onComplete?: OnApplicationComplete.NoOpOC}>) {
        return $this.appClient.transactions.call(ValidatorRegistryParamsFactory.emptyTokenRewards(params))
      },
    }
  })(this)
  ...
  readonly send = (($this) => {
    return {
       ...
       */
      async initStakingContract(params: Expand<CallParams<'initStakingContract(uint64)void'> & ExecuteParams & {onComplete?: OnApplicationComplete.NoOpOC}>) {
       ...
       * @returns The call result
       */
      async loadStakingContractData(params: Expand<CallParams<'loadStakingContractData(uint64,byte[])void'> & ExecuteParams & {onComplete?: OnApplicationComplete.NoOpOC}>) {
       ...
       * @returns The call result
       */
      async finalizeStakingContract(params: Expand<CallParams<'finalizeStakingContract()void'> & ExecuteParams & {onComplete?: OnApplicationComplete.NoOpOC}> = {args: []}) {
       ...
       * @returns The call result
       */
      async gas(params: Expand<CallParams<'gas()void'> & ExecuteParams & {onComplete?: OnApplicationComplete.NoOpOC}> = {args: []}) {
       ...
       * @returns The call result
       */
      async getMbrAmounts(params: Expand<CallParams<'getMbrAmounts()(uint64,uint64,uint64,uint64)'> & ExecuteParams & {onComplete?: OnApplicationComplete.NoOpOC}> = {args: []}) {
       ...
       * @returns The call result
       */
      async getProtocolConstraints(params: Expand<CallParams<'getProtocolConstraints()(uint64,uint64,uint64,uint64,uint64,uint64,uint64,uint64,uint64,uint64,uint64)'> & ExecuteParams & {onComplete?: OnApplicationComplete.NoOpOC}> = {args: []}) {
       ...
       * @returns The call result
       */
      async getNumValidators(params: Expand<CallParams<'getNumValidators()uint64'> & ExecuteParams & {onComplete?: OnApplicationComplete.NoOpOC}> = {args: []}) {
       ...
       * @returns The call result
       */
      async getValidatorConfig(params: Expand<CallParams<'getValidatorConfig(uint64)(uint64,address,address,uint64,uint8,address,uint64[4],uint64,uint64,uint64,uint32,uint32,address,uint64,uint64,uint8,uint64,uint64)'> & ExecuteParams & {onComplete?: OnApplicationComplete.NoOpOC}>) {
       ...
       * @returns The call result
       */
      async getValidatorState(params: Expand<CallParams<'getValidatorState(uint64)(uint16,uint64,uint64,uint64)'> & ExecuteParams & {onComplete?: OnApplicationComplete.NoOpOC}>) {
       ...
       * @returns The call result
       */
      async getValidatorOwnerAndManager(params: Expand<CallParams<'getValidatorOwnerAndManager(uint64)(address,address)'> & ExecuteParams & {onComplete?: OnApplicationComplete.NoOpOC}>) {
       ...
       * @returns The call result
       */
      async getPools(params: Expand<CallParams<'getPools(uint64)(uint64,uint16,uint64)[]'> & ExecuteParams & {onComplete?: OnApplicationComplete.NoOpOC}>) {
       ...
       * @returns The call result
       */
      async getPoolAppId(params: Expand<CallParams<'getPoolAppId(uint64,uint64)uint64'> & ExecuteParams & {onComplete?: OnApplicationComplete.NoOpOC}>) {
       ...
       * @returns The call result
       */
      async getPoolInfo(params: Expand<CallParams<'getPoolInfo((uint64,uint64,uint64))(uint64,uint16,uint64)'> & ExecuteParams & {onComplete?: OnApplicationComplete.NoOpOC}>) {
       ...
       * @returns The call result
       */
      async getCurMaxStakePerPool(params: Expand<CallParams<'getCurMaxStakePerPool(uint64)uint64'> & ExecuteParams & {onComplete?: OnApplicationComplete.NoOpOC}>) {
       ...
       * @returns The call result
       */
      async doesStakerNeedToPayMBR(params: Expand<CallParams<'doesStakerNeedToPayMBR(address)bool'> & ExecuteParams & {onComplete?: OnApplicationComplete.NoOpOC}>) {
       ...
       * @returns The call result
       */
      async getStakedPoolsForAccount(params: Expand<CallParams<'getStakedPoolsForAccount(address)(uint64,uint64,uint64)[]'> & ExecuteParams & {onComplete?: OnApplicationComplete.NoOpOC}>) {
       ...
       * @returns The call result
       */
      async getTokenPayoutRatio(params: Expand<CallParams<'getTokenPayoutRatio(uint64)(uint64[24],uint64)'> & ExecuteParams & {onComplete?: OnApplicationComplete.NoOpOC}>) {
       ...
       * @returns The call result
       */
      async getNodePoolAssignments(params: Expand<CallParams<'getNodePoolAssignments(uint64)((uint64[3])[8])'> & ExecuteParams & {onComplete?: OnApplicationComplete.NoOpOC}>) {
       ...
       * @returns The call result
       */
      async getNFDRegistryID(params: Expand<CallParams<'getNFDRegistryID()uint64'> & ExecuteParams & {onComplete?: OnApplicationComplete.NoOpOC}> = {args: []}) {
       ...
       */
      async addValidator(params: Expand<CallParams<'addValidator(pay,string,(uint64,address,address,uint64,uint8,address,uint64[4],uint64,uint64,uint64,uint32,uint32,address,uint64,uint64,uint8,uint64,uint64))uint64'> & ExecuteParams & {onComplete?: OnApplicationComplete.NoOpOC}>) {
       ...
       * @returns The call result
       */
      async changeValidatorManager(params: Expand<CallParams<'changeValidatorManager(uint64,address)void'> & ExecuteParams & {onComplete?: OnApplicationComplete.NoOpOC}>) {
       ...
       * @returns The call result
       */
      async changeValidatorSunsetInfo(params: Expand<CallParams<'changeValidatorSunsetInfo(uint64,uint64,uint64)void'> & ExecuteParams & {onComplete?: OnApplicationComplete.NoOpOC}>) {
       ...
       * @returns The call result
       */
      async changeValidatorNFD(params: Expand<CallParams<'changeValidatorNFD(uint64,uint64,string)void'> & ExecuteParams & {onComplete?: OnApplicationComplete.NoOpOC}>) {
       ...
       * @returns The call result
       */
      async changeValidatorCommissionAddress(params: Expand<CallParams<'changeValidatorCommissionAddress(uint64,address)void'> & ExecuteParams & {onComplete?: OnApplicationComplete.NoOpOC}>) {
       ...
       * @returns The call result
       */
      async changeValidatorRewardInfo(params: Expand<CallParams<'changeValidatorRewardInfo(uint64,uint8,address,uint64[4],uint64,uint64)void'> & ExecuteParams & {onComplete?: OnApplicationComplete.NoOpOC}>) {
       ...
       */
      async addPool(params: Expand<CallParams<'addPool(pay,uint64,uint64)(uint64,uint64,uint64)'> & ExecuteParams & {onComplete?: OnApplicationComplete.NoOpOC}>) {
       ...
       */
      async addStake(params: Expand<CallParams<'addStake(pay,uint64,uint64)(uint64,uint64,uint64)'> & ExecuteParams & {onComplete?: OnApplicationComplete.NoOpOC}>) {
       ...
       */
      async setTokenPayoutRatio(params: Expand<CallParams<'setTokenPayoutRatio(uint64)(uint64[24],uint64)'> & ExecuteParams & {onComplete?: OnApplicationComplete.NoOpOC}>) {
       ...
       * @returns The call result
       */
      async stakeUpdatedViaRewards(params: Expand<CallParams<'stakeUpdatedViaRewards((uint64,uint64,uint64),uint64,uint64,uint64,uint64)void'> & ExecuteParams & {onComplete?: OnApplicationComplete.NoOpOC}>) {
       ...
       * @returns The call result
       */
      async stakeRemoved(params: Expand<CallParams<'stakeRemoved((uint64,uint64,uint64),address,uint64,uint64,bool)void'> & ExecuteParams & {onComplete?: OnApplicationComplete.NoOpOC}>) {
       ...
       */
      async findPoolForStaker(params: Expand<CallParams<'findPoolForStaker(uint64,address,uint64)((uint64,uint64,uint64),bool,bool)'> & ExecuteParams & {onComplete?: OnApplicationComplete.NoOpOC}>) {
       ...
       * @returns The call result
       */
      async movePoolToNode(params: Expand<CallParams<'movePoolToNode(uint64,uint64,uint64)void'> & ExecuteParams & {onComplete?: OnApplicationComplete.NoOpOC}>) {
       ...
       */
      async emptyTokenRewards(params: Expand<CallParams<'emptyTokenRewards(uint64,address)uint64'> & ExecuteParams & {onComplete?: OnApplicationComplete.NoOpOC}>) {
  ...
  public newGroup(): ValidatorRegistryComposer {
    ...
    return {
      ...
      initStakingContract(params: CallParams<'initStakingContract(uint64)void'> & {onComplete?: OnApplicationComplete.NoOpOC}) {
        composer.addAppCallMethodCall(client.params.initStakingContract(params))
      ...
      loadStakingContractData(params: CallParams<'loadStakingContractData(uint64,byte[])void'> & {onComplete?: OnApplicationComplete.NoOpOC}) {
        composer.addAppCallMethodCall(client.params.loadStakingContractData(params))
        resultMappers.push(undefined)
        return this
      },
      /**
      ...
      finalizeStakingContract(params: CallParams<'finalizeStakingContract()void'> & {onComplete?: OnApplicationComplete.NoOpOC}) {
        composer.addAppCallMethodCall(client.params.finalizeStakingContract(params))
        resultMappers.push(undefined)
        return this
      },
      /**
      ...
      gas(params: CallParams<'gas()void'> & {onComplete?: OnApplicationComplete.NoOpOC}) {
        composer.addAppCallMethodCall(client.params.gas(params))
        resultMappers.push(undefined)
        return this
      },
      /**
      ...
      getMbrAmounts(params: CallParams<'getMbrAmounts()(uint64,uint64,uint64,uint64)'> & {onComplete?: OnApplicationComplete.NoOpOC}) {
        composer.addAppCallMethodCall(client.params.getMbrAmounts(params))
      ...
      getProtocolConstraints(params: CallParams<'getProtocolConstraints()(uint64,uint64,uint64,uint64,uint64,uint64,uint64,uint64,uint64,uint64,uint64)'> & {onComplete?: OnApplicationComplete.NoOpOC}) {
        composer.addAppCallMethodCall(client.params.getProtocolConstraints(params))
      ...
      getNumValidators(params: CallParams<'getNumValidators()uint64'> & {onComplete?: OnApplicationComplete.NoOpOC}) {
        composer.addAppCallMethodCall(client.params.getNumValidators(params))
      ...
      getValidatorConfig(params: CallParams<'getValidatorConfig(uint64)(uint64,address,address,uint64,uint8,address,uint64[4],uint64,uint64,uint64,uint32,uint32,address,uint64,uint64,uint8,uint64,uint64)'> & {onComplete?: OnApplicationComplete.NoOpOC}) {
        composer.addAppCallMethodCall(client.params.getValidatorConfig(params))
      ...
      getValidatorState(params: CallParams<'getValidatorState(uint64)(uint16,uint64,uint64,uint64)'> & {onComplete?: OnApplicationComplete.NoOpOC}) {
        composer.addAppCallMethodCall(client.params.getValidatorState(params))
      ...
      getValidatorOwnerAndManager(params: CallParams<'getValidatorOwnerAndManager(uint64)(address,address)'> & {onComplete?: OnApplicationComplete.NoOpOC}) {
        composer.addAppCallMethodCall(client.params.getValidatorOwnerAndManager(params))
      ...
      getPools(params: CallParams<'getPools(uint64)(uint64,uint16,uint64)[]'> & {onComplete?: OnApplicationComplete.NoOpOC}) {
        composer.addAppCallMethodCall(client.params.getPools(params))
      ...
      getPoolAppId(params: CallParams<'getPoolAppId(uint64,uint64)uint64'> & {onComplete?: OnApplicationComplete.NoOpOC}) {
        composer.addAppCallMethodCall(client.params.getPoolAppId(params))
      ...
      getPoolInfo(params: CallParams<'getPoolInfo((uint64,uint64,uint64))(uint64,uint16,uint64)'> & {onComplete?: OnApplicationComplete.NoOpOC}) {
        composer.addAppCallMethodCall(client.params.getPoolInfo(params))
      ...
      getCurMaxStakePerPool(params: CallParams<'getCurMaxStakePerPool(uint64)uint64'> & {onComplete?: OnApplicationComplete.NoOpOC}) {
        composer.addAppCallMethodCall(client.params.getCurMaxStakePerPool(params))
      ...
      doesStakerNeedToPayMBR(params: CallParams<'doesStakerNeedToPayMBR(address)bool'> & {onComplete?: OnApplicationComplete.NoOpOC}) {
        composer.addAppCallMethodCall(client.params.doesStakerNeedToPayMBR(params))
      ...
      getStakedPoolsForAccount(params: CallParams<'getStakedPoolsForAccount(address)(uint64,uint64,uint64)[]'> & {onComplete?: OnApplicationComplete.NoOpOC}) {
        composer.addAppCallMethodCall(client.params.getStakedPoolsForAccount(params))
      ...
      getTokenPayoutRatio(params: CallParams<'getTokenPayoutRatio(uint64)(uint64[24],uint64)'> & {onComplete?: OnApplicationComplete.NoOpOC}) {
        composer.addAppCallMethodCall(client.params.getTokenPayoutRatio(params))
      ...
      getNodePoolAssignments(params: CallParams<'getNodePoolAssignments(uint64)((uint64[3])[8])'> & {onComplete?: OnApplicationComplete.NoOpOC}) {
        composer.addAppCallMethodCall(client.params.getNodePoolAssignments(params))
      ...
      getNFDRegistryID(params: CallParams<'getNFDRegistryID()uint64'> & {onComplete?: OnApplicationComplete.NoOpOC}) {
        composer.addAppCallMethodCall(client.params.getNFDRegistryID(params))
      ...
      addValidator(params: CallParams<'addValidator(pay,string,(uint64,address,address,uint64,uint8,address,uint64[4],uint64,uint64,uint64,uint32,uint32,address,uint64,uint64,uint8,uint64,uint64))uint64'> & {onComplete?: OnApplicationComplete.NoOpOC}) {
        composer.addAppCallMethodCall(client.params.addValidator(params))
      ...
      changeValidatorManager(params: CallParams<'changeValidatorManager(uint64,address)void'> & {onComplete?: OnApplicationComplete.NoOpOC}) {
        composer.addAppCallMethodCall(client.params.changeValidatorManager(params))
        resultMappers.push(undefined)
        return this
      },
      /**
      ...
      changeValidatorSunsetInfo(params: CallParams<'changeValidatorSunsetInfo(uint64,uint64,uint64)void'> & {onComplete?: OnApplicationComplete.NoOpOC}) {
        composer.addAppCallMethodCall(client.params.changeValidatorSunsetInfo(params))
        resultMappers.push(undefined)
        return this
      },
      /**
      ...
      changeValidatorNFD(params: CallParams<'changeValidatorNFD(uint64,uint64,string)void'> & {onComplete?: OnApplicationComplete.NoOpOC}) {
        composer.addAppCallMethodCall(client.params.changeValidatorNFD(params))
        resultMappers.push(undefined)
        return this
      },
      /**
      ...
      changeValidatorCommissionAddress(params: CallParams<'changeValidatorCommissionAddress(uint64,address)void'> & {onComplete?: OnApplicationComplete.NoOpOC}) {
        composer.addAppCallMethodCall(client.params.changeValidatorCommissionAddress(params))
        resultMappers.push(undefined)
        return this
      },
      /**
      ...
      changeValidatorRewardInfo(params: CallParams<'changeValidatorRewardInfo(uint64,uint8,address,uint64[4],uint64,uint64)void'> & {onComplete?: OnApplicationComplete.NoOpOC}) {
        composer.addAppCallMethodCall(client.params.changeValidatorRewardInfo(params))
        resultMappers.push(undefined)
        return this
      },
      /**
      ...
      addPool(params: CallParams<'addPool(pay,uint64,uint64)(uint64,uint64,uint64)'> & {onComplete?: OnApplicationComplete.NoOpOC}) {
        composer.addAppCallMethodCall(client.params.addPool(params))
      ...
      addStake(params: CallParams<'addStake(pay,uint64,uint64)(uint64,uint64,uint64)'> & {onComplete?: OnApplicationComplete.NoOpOC}) {
        composer.addAppCallMethodCall(client.params.addStake(params))
      ...
      setTokenPayoutRatio(params: CallParams<'setTokenPayoutRatio(uint64)(uint64[24],uint64)'> & {onComplete?: OnApplicationComplete.NoOpOC}) {
        composer.addAppCallMethodCall(client.params.setTokenPayoutRatio(params))
      ...
      stakeUpdatedViaRewards(params: CallParams<'stakeUpdatedViaRewards((uint64,uint64,uint64),uint64,uint64,uint64,uint64)void'> & {onComplete?: OnApplicationComplete.NoOpOC}) {
        composer.addAppCallMethodCall(client.params.stakeUpdatedViaRewards(params))
        resultMappers.push(undefined)
        return this
      },
      /**
      ...
      stakeRemoved(params: CallParams<'stakeRemoved((uint64,uint64,uint64),address,uint64,uint64,bool)void'> & {onComplete?: OnApplicationComplete.NoOpOC}) {
        composer.addAppCallMethodCall(client.params.stakeRemoved(params))
        resultMappers.push(undefined)
        return this
      },
      /**
      ...
      findPoolForStaker(params: CallParams<'findPoolForStaker(uint64,address,uint64)((uint64,uint64,uint64),bool,bool)'> & {onComplete?: OnApplicationComplete.NoOpOC}) {
        composer.addAppCallMethodCall(client.params.findPoolForStaker(params))
      ...
      movePoolToNode(params: CallParams<'movePoolToNode(uint64,uint64,uint64)void'> & {onComplete?: OnApplicationComplete.NoOpOC}) {
        composer.addAppCallMethodCall(client.params.movePoolToNode(params))
        resultMappers.push(undefined)
        return this
      },
      /**
      ...
      emptyTokenRewards(params: CallParams<'emptyTokenRewards(uint64,address)uint64'> & {onComplete?: OnApplicationComplete.NoOpOC}) {
        composer.addAppCallMethodCall(client.params.emptyTokenRewards(params))
...
export type ValidatorRegistryComposer<TReturns extends [...any[]] = []> = {
   ...
   */
  execute(params?: ExecuteParams): Promise<ValidatorRegistryComposerResults<TReturns>>
}
