...
export type StateAppArgs = {
  ...
  obj: {
    ...
    'call_with_references(asset,account,application)uint64': {
      asset: bigint
      account: string | Address | Uint8Array
      application: bigint
    }
  ...
  tuple: {
    ...
    'call_with_references(asset,account,application)uint64': [asset: bigint, account: string | Address | Uint8Array, application: bigint]
