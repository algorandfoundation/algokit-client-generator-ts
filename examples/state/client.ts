...
export class StateAppClient {
  ...
  public get create() {
    ...
    return {
       ...
       * @returns The create result
       */
      async createAbi(args: MethodArgs<'create_abi(string)string'>, params: AppClientCallCoreParams & AppClientCompilationParams & (OnCompleteNoOp) = {}): Promise<Partial<AppCompilationResult> & AppReference & AppCallTransactionResultOfType<MethodReturn<'create_abi(string)string'>>> {
        return $this.mapCreateReturnValue(await $this.appClient.create(StateAppCallFactory.create.createAbi(args, params)))
      },
    }
  }
  ...
  public get update() {
    ...
    return {
       ...
       * @returns The update result
       */
      async updateAbi(args: MethodArgs<'update_abi(string)string'>, params: AppClientCallCoreParams & AppClientCompilationParams = {}): Promise<Partial<AppCompilationResult> & AppCallTransactionResultOfType<MethodReturn<'update_abi(string)string'>>> {
        return $this.mapUpdateReturnValue(await $this.appClient.update(StateAppCallFactory.update.updateAbi(args, params)))
      },
    }
  }
