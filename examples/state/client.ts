...
export class StateAppClient {
  ...
  readonly params = (($this) => {
    return {
       ...
       * @returns The call params
       */
      defaultValue(params: Expand<CallParams<'default_value(string)string'> & {onComplete?: OnApplicationComplete.NoOpOC}>) {
       ...
       * @returns The call params
       */
      defaultValueInt(params: Expand<CallParams<'default_value_int(uint64)uint64'> & {onComplete?: OnApplicationComplete.NoOpOC}>) {
  ...
  readonly send = (($this) => {
    return {
       ...
       * @returns The call result
       */
      async defaultValue(params: Expand<CallParams<'default_value(string)string'> & ExecuteParams & {onComplete?: OnApplicationComplete.NoOpOC}>) {
       ...
       * @returns The call result
       */
      async defaultValueInt(params: Expand<CallParams<'default_value_int(uint64)uint64'> & ExecuteParams & {onComplete?: OnApplicationComplete.NoOpOC}>) {
