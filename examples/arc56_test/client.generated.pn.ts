...
/**
 * Converts the ABI return of a { foo: uint16; bar: uint16 } to the struct representation
 */
export function _foo_uint16_bar_uint16_ABIReturnFormatter(returnValue: ABIReturn | undefined) {
  if (returnValue === undefined) return undefined
  if (returnValue.decodeError) throw returnValue.decodeError
  return getABIStructFromABITuple<_foo_uint16_bar_uint16_>(returnValue.returnValue as ABIValue[],
    {foo: 'uint16', bar: 'uint16'}
  )
}
/**
 * Converts a { foo: uint16; bar: uint16 } to an ABI tuple
 */
export function _foo_uint16_bar_uint16_ToABITuple(struct: _foo_uint16_bar_uint16_) {
...
/**
 * Converts the ABI return of a Outputs to the struct representation
 */
export function OutputsABIReturnFormatter(returnValue: ABIReturn | undefined) {
  if (returnValue === undefined) return undefined
  if (returnValue.decodeError) throw returnValue.decodeError
  return getABIStructFromABITuple<Outputs>(returnValue.returnValue as ABIValue[],
    {sum: 'uint64', difference: 'uint64'}
  )
}
/**
 * Converts a Outputs to an ABI tuple
 */
export function OutputsToABITuple(struct: Outputs) {
  return getABITupleFromABIStruct(struct,
    {sum: 'uint64', difference: 'uint64'}
  )
}
...
/**
 * Converts the ABI return of a Inputs to the struct representation
 */
export function InputsABIReturnFormatter(returnValue: ABIReturn | undefined) {
  if (returnValue === undefined) return undefined
  if (returnValue.decodeError) throw returnValue.decodeError
  return getABIStructFromABITuple<Inputs>(returnValue.returnValue as ABIValue[],
    {add: {a: 'uint64', b: 'uint64'}, subtract: {a: 'uint64', b: 'uint64'}}
  )
}
/**
 * Converts a Inputs to an ABI tuple
 */
export function InputsToABITuple(struct: Inputs) {
  return getABITupleFromABIStruct(struct,
    {add: {a: 'uint64', b: 'uint64'}, subtract: {a: 'uint64', b: 'uint64'}}
  )
}
...
export abstract class ARC56TestParamsFactory {
  ...
  static foo(params: CallParams<'foo(((uint64,uint64),(uint64,uint64)))(uint64,uint64)'> & CallOnComplete): AppClientMethodCallParams & CallOnComplete {
    return {
      ...
      args: Array.isArray(params.args) ? params.args : [InputsToABITuple(params.args.inputs)],
      returnValueFormatter: OutputsABIReturnFormatter
    }
  }
}
...
export class ARC56TestFactory {
  ...
  public async getAppClientByCreatorAddressAndName(
    ...
    return new ARC56TestClient(await this.appFactory.getAppClientByCreatorAddressAndName(params))
  }
  ...
  public async deploy(params: ARC56TestDeployParams = {}) {
    ...
    return { result: result.result, app: new ARC56TestClient(result.app) }
  }
      ...
      get create() {
        return {
          ...
          async createApplication(params: Expand<CallParams<'createApplication()void'> & AppClientCompilationParams & CreateSchema & ExecuteParams & {onComplete?: OnApplicationComplete.NoOpOC}> = {args: []}) {
            const result = await $this.appFactory.create(ARC56TestParamsFactory.create.createApplication(params))
            return { result: { ...result.result, return: result.result.return as undefined | MethodReturn<'createApplication()void'> }, app: new ARC56TestClient(result.app) }
          },
        }
      },
...
export class ARC56TestClient {
  ...
  decodeReturnValue<TSignature extends ARC56TestNonVoidMethodSignatures>(method: TSignature, returnValue: ABIReturn | undefined) {
    return returnValue !== undefined ? getArc56ReturnValue<MethodReturn<TSignature>>(returnValue, this.appClient.getABIMethod(method), {"{ foo: uint16; bar: uint16 }": {foo: 'uint16', bar: 'uint16'}, Outputs: {sum: 'uint64', difference: 'uint64'}, Inputs: {add: {a: 'uint64', b: 'uint64'}, subtract: {a: 'uint64', b: 'uint64'}}}) : undefined
  }
    ...
    return {
      ...
      get optIn() {
        return {
           ...
           */
          optInToApplication(params: Expand<CallParams<'optInToApplication()void'>> = {args: []}) {
            return $this.appClient.transactions.optIn(ARC56TestParamsFactory.optIn.optInToApplication(params))
          },
        }
      },
       ...
       */
      foo(params: Expand<CallParams<'foo(((uint64,uint64),(uint64,uint64)))(uint64,uint64)'> & {onComplete?: OnApplicationComplete.NoOpOC}>) {
        return $this.appClient.transactions.call(ARC56TestParamsFactory.foo(params))
      },
    }
  })(this)
    ...
    return {
      ...
      get optIn() {
        return {
           ...
           */
          async optInToApplication(params: Expand<CallParams<'optInToApplication()void'> & ExecuteParams> = {args: []}) {
       ...
       */
      async foo(params: Expand<CallParams<'foo(((uint64,uint64),(uint64,uint64)))(uint64,uint64)'> & ExecuteParams & {onComplete?: OnApplicationComplete.NoOpOC}>) {
  ...
  public newGroup(): ARC56TestComposer {
    ...
    return {
      ...
      foo(params: CallParams<'foo(((uint64,uint64),(uint64,uint64)))(uint64,uint64)'> & {onComplete?: OnApplicationComplete.NoOpOC}) {
        composer.addAppCallMethodCall(client.params.foo(params))
      ...
      get optIn() {
        ...
        return {
          optInToApplication(params: CallParams<'optInToApplication()void'>) {
            composer.addAppCallMethodCall(client.params.optIn.optInToApplication(params))
...
export type ARC56TestComposer<TReturns extends [...any[]] = []> = {
   ...
   */
  execute(params?: ExecuteParams): Promise<ARC56TestComposerResults<TReturns>>
}
