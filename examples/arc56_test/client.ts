 ...
 */
export function FooUint16BarUint16ABIReturnFormatter(returnValue: ABIReturn | undefined) {
  if (returnValue === undefined) return undefined
  if (returnValue.decodeError) throw returnValue.decodeError
  return getABIStructFromABITuple<FooUint16BarUint16>(returnValue.returnValue as ABIValue[],
 ...
 */
export function FooUint16BarUint16ToABITuple(struct: FooUint16BarUint16) {
...
export class Arc56TestClient {
  ...
  decodeReturnValue<TSignature extends Arc56TestNonVoidMethodSignatures>(method: TSignature, returnValue: ABIReturn | undefined) {
    return returnValue !== undefined ? getArc56ReturnValue<MethodReturn<TSignature>>(returnValue, this.appClient.getABIMethod(method), {fooUint16BarUint16: {foo: 'uint16', bar: 'uint16'}, outputs: {sum: 'uint64', difference: 'uint64'}, inputs: {add: {a: 'uint64', b: 'uint64'}, subtract: {a: 'uint64', b: 'uint64'}}}) : undefined
  }
